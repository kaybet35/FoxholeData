...
{
    bool bUseComplexAsSimpleCollision;                                                // 0x0408 (size: 0x1)
    bool bUseAsyncCooking;                                                            // 0x0409 (size: 0x1)
    class UBodySetup* ProcMeshBodySetup;                                              // 0x0410 (size: 0x8)
    TArray<FProcMeshSection> ProcMeshSections;                                        // 0x0418 (size: 0x10)
    TArray<FKConvexElem> CollisionConvexElems;                                        // 0x0428 (size: 0x10)
    FBoxSphereBounds LocalBounds;                                                     // 0x0438 (size: 0x1C)
    TArray<class UBodySetup*> AsyncBodySetupQueue;                                    // 0x0458 (size: 0x10)
