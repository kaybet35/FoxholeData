...
class ABPBirch03Replacement_C : public AClientFoliageReplacement
{
    ...
    class UParticleSystemComponent* NoMansLandSplinter;                               // 0x0298 (size: 0x8)
    class UAudioComponent* Fire;                                                      // 0x02A0 (size: 0x8)
    class UAudioComponent* Splinter;                                                  // 0x02A8 (size: 0x8)
    class UParticleSystemComponent* NoMansLandTreeFire;                               // 0x02B0 (size: 0x8)
