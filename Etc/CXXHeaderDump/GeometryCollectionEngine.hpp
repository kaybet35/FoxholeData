...
{
    class UGeometryCollectionComponent* GeometryCollectionComponent;                  // 0x0218 (size: 0x8)
    class UGeometryCollectionDebugDrawComponent* GeometryCollectionDebugDrawComponent; // 0x0220 (size: 0x8)
...
{
    FGeometryCollectionDebugDrawWarningMessage WarningMessage;                        // 0x0218 (size: 0x1)
    FGeometryCollectionDebugDrawActorSelectedRigidBody SelectedRigidBody;             // 0x0220 (size: 0x18)
    bool bDebugDrawWholeCollection;                                                   // 0x0238 (size: 0x1)
    bool bDebugDrawHierarchy;                                                         // 0x0239 (size: 0x1)
    bool bDebugDrawClustering;                                                        // 0x023A (size: 0x1)
    EGeometryCollectionDebugDrawActorHideGeometry HideGeometry;                       // 0x023B (size: 0x1)
    bool bShowRigidBodyId;                                                            // 0x023C (size: 0x1)
    bool bShowRigidBodyCollision;                                                     // 0x023D (size: 0x1)
    bool bCollisionAtOrigin;                                                          // 0x023E (size: 0x1)
    bool bShowRigidBodyTransform;                                                     // 0x023F (size: 0x1)
    bool bShowRigidBodyInertia;                                                       // 0x0240 (size: 0x1)
    bool bShowRigidBodyVelocity;                                                      // 0x0241 (size: 0x1)
    bool bShowRigidBodyForce;                                                         // 0x0242 (size: 0x1)
    bool bShowRigidBodyInfos;                                                         // 0x0243 (size: 0x1)
    bool bShowTransformIndex;                                                         // 0x0244 (size: 0x1)
    bool bShowTransform;                                                              // 0x0245 (size: 0x1)
    bool bShowParent;                                                                 // 0x0246 (size: 0x1)
    bool bShowLevel;                                                                  // 0x0247 (size: 0x1)
    bool bShowConnectivityEdges;                                                      // 0x0248 (size: 0x1)
    bool bShowGeometryIndex;                                                          // 0x0249 (size: 0x1)
    bool bShowGeometryTransform;                                                      // 0x024A (size: 0x1)
    bool bShowBoundingBox;                                                            // 0x024B (size: 0x1)
    bool bShowFaces;                                                                  // 0x024C (size: 0x1)
    bool bShowFaceIndices;                                                            // 0x024D (size: 0x1)
    bool bShowFaceNormals;                                                            // 0x024E (size: 0x1)
    bool bShowSingleFace;                                                             // 0x024F (size: 0x1)
    int32 SingleFaceIndex;                                                            // 0x0250 (size: 0x4)
    bool bShowVertices;                                                               // 0x0254 (size: 0x1)
    bool bShowVertexIndices;                                                          // 0x0255 (size: 0x1)
    bool bShowVertexNormals;                                                          // 0x0256 (size: 0x1)
    bool bUseActiveVisualization;                                                     // 0x0257 (size: 0x1)
    float PointThickness;                                                             // 0x0258 (size: 0x4)
    float LineThickness;                                                              // 0x025C (size: 0x4)
    bool bTextShadow;                                                                 // 0x0260 (size: 0x1)
    float TextScale;                                                                  // 0x0264 (size: 0x4)
    float NormalScale;                                                                // 0x0268 (size: 0x4)
    float AxisScale;                                                                  // 0x026C (size: 0x4)
    float ArrowScale;                                                                 // 0x0270 (size: 0x4)
    FColor RigidBodyIdColor;                                                          // 0x0274 (size: 0x4)
    float RigidBodyTransformScale;                                                    // 0x0278 (size: 0x4)
    FColor RigidBodyCollisionColor;                                                   // 0x027C (size: 0x4)
    FColor RigidBodyInertiaColor;                                                     // 0x0280 (size: 0x4)
    FColor RigidBodyVelocityColor;                                                    // 0x0284 (size: 0x4)
    FColor RigidBodyForceColor;                                                       // 0x0288 (size: 0x4)
    FColor RigidBodyInfoColor;                                                        // 0x028C (size: 0x4)
    FColor TransformIndexColor;                                                       // 0x0290 (size: 0x4)
    float TransformScale;                                                             // 0x0294 (size: 0x4)
    FColor LevelColor;                                                                // 0x0298 (size: 0x4)
    FColor ParentColor;                                                               // 0x029C (size: 0x4)
    float ConnectivityEdgeThickness;                                                  // 0x02A0 (size: 0x4)
    FColor GeometryIndexColor;                                                        // 0x02A4 (size: 0x4)
    float GeometryTransformScale;                                                     // 0x02A8 (size: 0x4)
    FColor BoundingBoxColor;                                                          // 0x02AC (size: 0x4)
    FColor FaceColor;                                                                 // 0x02B0 (size: 0x4)
    FColor FaceIndexColor;                                                            // 0x02B4 (size: 0x4)
    FColor FaceNormalColor;                                                           // 0x02B8 (size: 0x4)
    FColor SingleFaceColor;                                                           // 0x02BC (size: 0x4)
    FColor VertexColor;                                                               // 0x02C0 (size: 0x4)
    FColor VertexIndexColor;                                                          // 0x02C4 (size: 0x4)
    FColor VertexNormalColor;                                                         // 0x02C8 (size: 0x4)
    class UBillboardComponent* SpriteComponent;                                       // 0x02D0 (size: 0x8)

}; // Size: 0x300

class AGeometryCollectionRenderLevelSetActor : public AActor
{
    class UVolumeTexture* TargetVolumeTexture;                                        // 0x0218 (size: 0x8)
    class UMaterial* RayMarchMaterial;                                                // 0x0220 (size: 0x8)
    float SurfaceTolerance;                                                           // 0x0228 (size: 0x4)
    float Isovalue;                                                                   // 0x022C (size: 0x4)
    bool Enabled;                                                                     // 0x0230 (size: 0x1)
    bool RenderVolumeBoundingBox;                                                     // 0x0231 (size: 0x1)
...
{
    class AChaosSolverActor* ChaosSolverActor;                                        // 0x0408 (size: 0x8)
    class UGeometryCollection* RestCollection;                                        // 0x04F0 (size: 0x8)
    TArray<class AFieldSystemActor*> InitializationFields;                            // 0x04F8 (size: 0x10)
    bool Simulating;                                                                  // 0x0508 (size: 0x1)
    EObjectStateTypeEnum ObjectType;                                                  // 0x0510 (size: 0x1)
    bool EnableClustering;                                                            // 0x0511 (size: 0x1)
    int32 ClusterGroupIndex;                                                          // 0x0514 (size: 0x4)
    int32 MaxClusterLevel;                                                            // 0x0518 (size: 0x4)
    TArray<float> DamageThreshold;                                                    // 0x0520 (size: 0x10)
    EClusterConnectionTypeEnum ClusterConnectionType;                                 // 0x0530 (size: 0x1)
    int32 CollisionGroup;                                                             // 0x0534 (size: 0x4)
    float CollisionSampleFraction;                                                    // 0x0538 (size: 0x4)
    class UChaosPhysicalMaterial* PhysicalMaterial;                                   // 0x0540 (size: 0x8)
    EInitialVelocityTypeEnum InitialVelocityType;                                     // 0x0548 (size: 0x1)
    FVector InitialLinearVelocity;                                                    // 0x054C (size: 0xC)
    FVector InitialAngularVelocity;                                                   // 0x0558 (size: 0xC)
    FGeomComponentCacheParameters CacheParameters;                                    // 0x0568 (size: 0x50)
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsStateChange NotifyGeometryCollectionPhysicsStateChange; // 0x05B8 (size: 0x10)
    void NotifyGeometryCollectionPhysicsStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentNotifyGeometryCollectionPhysicsLoadingStateChange NotifyGeometryCollectionPhysicsLoadingStateChange; // 0x05C8 (size: 0x10)
    void NotifyGeometryCollectionPhysicsLoadingStateChange(class UGeometryCollectionComponent* FracturedComponent);
    FGeometryCollectionComponentOnChaosBreakEvent OnChaosBreakEvent;                  // 0x05F0 (size: 0x10)
    void OnChaosBreakEvent(const FChaosBreakEvent& BreakEvent);
    float DesiredCacheTime;                                                           // 0x0600 (size: 0x4)
    bool CachePlayback;                                                               // 0x0604 (size: 0x1)
    FGeometryCollectionComponentOnChaosPhysicsCollision OnChaosPhysicsCollision;      // 0x0608 (size: 0x10)
    void OnChaosPhysicsCollision(const FChaosPhysicsCollisionInfo& CollisionInfo);
    bool bNotifyBreaks;                                                               // 0x0618 (size: 0x1)
    bool bNotifyCollisions;                                                           // 0x0619 (size: 0x1)
    class UBodySetup* DummyBodySetup;                                                 // 0x07C8 (size: 0x8)
