...
{
    class UStaticMeshComponent* EntranceRampBack;                                     // 0x0800 (size: 0x8)
    class UStaticMeshComponent* EntranceRampFront;                                    // 0x0808 (size: 0x8)
    class USpawnPointComponent* SpawnPoint;                                           // 0x0810 (size: 0x8)
    class USpawnPointComponent* SpawnPoint2;                                          // 0x0818 (size: 0x8)
    class UCameraComponent* ViewTargetCamera;                                         // 0x0820 (size: 0x8)
