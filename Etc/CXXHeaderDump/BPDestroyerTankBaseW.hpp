...
class ABPDestroyerTankBaseW_C : public ABattleTank
{
    ...
    class UVehicleSeatComponent* CommanderSeat2;                                      // 0x1390 (size: 0x8)
    class USeatExitComponent* CommanderExit;                                          // 0x1398 (size: 0x8)
    class USeatExitComponent* GunnerExit;                                             // 0x13A0 (size: 0x8)
    class USeatExitComponent* DriverExit;                                             // 0x13A8 (size: 0x8)
    class USeatTriggerComponent* CommanderTrigger;                                    // 0x13B0 (size: 0x8)
    class USeatTriggerComponent* GunnerTrigger;                                       // 0x13B8 (size: 0x8)
    class USeatTriggerComponent* DriverTrigger;                                       // 0x13C0 (size: 0x8)
    class UParticleSystemComponent* Exhaust;                                          // 0x13C8 (size: 0x8)
    class USpotLightComponent* SpotLightTurret;                                       // 0x13D0 (size: 0x8)
    class UStaticMeshComponent* LightTurret;                                          // 0x13D8 (size: 0x8)
