...
class AInteractiveFoliageActor : public AStaticMeshActor
{
    ...
    FVector TouchingActorEntryPosition;                                               // 0x0230 (size: 0xC)
    FVector FoliageVelocity;                                                          // 0x023C (size: 0xC)
    FVector FoliageForce;                                                             // 0x0248 (size: 0xC)
    FVector FoliagePosition;                                                          // 0x0254 (size: 0xC)
    float FoliageDamageImpulseScale;                                                  // 0x0260 (size: 0x4)
    float FoliageTouchImpulseScale;                                                   // 0x0264 (size: 0x4)
    float FoliageStiffness;                                                           // 0x0268 (size: 0x4)
    float FoliageStiffnessQuadratic;                                                  // 0x026C (size: 0x4)
    float FoliageDamping;                                                             // 0x0270 (size: 0x4)
    float MaxDamageImpulse;                                                           // 0x0274 (size: 0x4)
    float MaxTouchImpulse;                                                            // 0x0278 (size: 0x4)
    float MaxForce;                                                                   // 0x027C (size: 0x4)
    float Mass;                                                                       // 0x0280 (size: 0x4)
...
{
    class AProceduralFoliageVolume* ProceduralFoliageVolume;                          // 0x0250 (size: 0x8)

}; // Size: 0x258

class AProceduralFoliageVolume : public AVolume
{
    class UProceduralFoliageComponent* ProceduralComponent;                           // 0x0250 (size: 0x8)

}; // Size: 0x258

class UFoliageInstancedStaticMeshComponent : public UHierarchicalInstancedStaticMeshComponent
{
    FFoliageInstancedStaticMeshComponentOnInstanceTakePointDamage OnInstanceTakePointDamage; // 0x0608 (size: 0x10)
    ...
    FFoliageInstancedStaticMeshComponentOnInstanceTakeRadialDamage OnInstanceTakeRadialDamage; // 0x0618 (size: 0x10)
...
class UFoliageType : public UObject
{
    ...
    FBodyInstance BodyInstance;                                                       // 0x0158 (size: 0x110)
    TEnumAsByte<EHasCustomNavigableGeometry::Type> CustomNavigableGeometry;           // 0x0268 (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x0269 (size: 0x1)
    uint8 bRenderCustomDepth;                                                         // 0x026C (size: 0x1)
    int32 CustomDepthStencilValue;                                                    // 0x0270 (size: 0x4)
    int32 TranslucencySortPriority;                                                   // 0x0274 (size: 0x4)
    float CollisionRadius;                                                            // 0x0278 (size: 0x4)
    float ShadeRadius;                                                                // 0x027C (size: 0x4)
    int32 NumSteps;                                                                   // 0x0280 (size: 0x4)
    float InitialSeedDensity;                                                         // 0x0284 (size: 0x4)
    float AverageSpreadDistance;                                                      // 0x0288 (size: 0x4)
    float SpreadVariance;                                                             // 0x028C (size: 0x4)
    int32 SeedsPerStep;                                                               // 0x0290 (size: 0x4)
    int32 DistributionSeed;                                                           // 0x0294 (size: 0x4)
    float MaxInitialSeedOffset;                                                       // 0x0298 (size: 0x4)
    bool bCanGrowInShade;                                                             // 0x029C (size: 0x1)
    bool bSpawnsInShade;                                                              // 0x029D (size: 0x1)
    float MaxInitialAge;                                                              // 0x02A0 (size: 0x4)
    float MaxAge;                                                                     // 0x02A4 (size: 0x4)
    float OverlapPriority;                                                            // 0x02A8 (size: 0x4)
    FFloatInterval ProceduralScale;                                                   // 0x02AC (size: 0x8)
    FRuntimeFloatCurve ScaleCurve;                                                    // 0x02B8 (size: 0x88)
    int32 ChangeCount;                                                                // 0x0340 (size: 0x4)
    uint8 ReapplyDensity;                                                             // 0x0344 (size: 0x1)
    uint8 ReapplyRadius;                                                              // 0x0344 (size: 0x1)
    uint8 ReapplyAlignToNormal;                                                       // 0x0344 (size: 0x1)
    uint8 ReapplyRandomYaw;                                                           // 0x0344 (size: 0x1)
    uint8 ReapplyScaling;                                                             // 0x0344 (size: 0x1)
    uint8 ReapplyScaleX;                                                              // 0x0344 (size: 0x1)
    uint8 ReapplyScaleY;                                                              // 0x0344 (size: 0x1)
    uint8 ReapplyScaleZ;                                                              // 0x0344 (size: 0x1)
    uint8 ReapplyRandomPitchAngle;                                                    // 0x0345 (size: 0x1)
    uint8 ReapplyGroundSlope;                                                         // 0x0345 (size: 0x1)
    uint8 ReapplyHeight;                                                              // 0x0345 (size: 0x1)
    uint8 ReapplyLandscapeLayers;                                                     // 0x0345 (size: 0x1)
    uint8 ReapplyZOffset;                                                             // 0x0345 (size: 0x1)
    uint8 ReapplyCollisionWithWorld;                                                  // 0x0345 (size: 0x1)
    uint8 ReapplyVertexColorMask;                                                     // 0x0345 (size: 0x1)
    uint8 bEnableDensityScaling;                                                      // 0x0345 (size: 0x1)
    TArray<class URuntimeVirtualTexture*> RuntimeVirtualTextures;                     // 0x0348 (size: 0x10)
    int32 VirtualTextureCullMips;                                                     // 0x0358 (size: 0x4)
    ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType;                  // 0x035C (size: 0x1)

}; // Size: 0x360

class UFoliageType_Actor : public UFoliageType
{
    TSubclassOf<class AActor> ActorClass;                                             // 0x0360 (size: 0x8)
    bool bShouldAttachToBaseComponent;                                                // 0x0368 (size: 0x1)

}; // Size: 0x370

class UFoliageType_InstancedStaticMesh : public UFoliageType
{
    class UStaticMesh* Mesh;                                                          // 0x0360 (size: 0x8)
    TArray<class UMaterialInterface*> OverrideMaterials;                              // 0x0368 (size: 0x10)
    TSubclassOf<class UFoliageInstancedStaticMeshComponent> ComponentClass;           // 0x0378 (size: 0x8)
