...
class ABPEmplacedMultiC_C : public AEmplacedArtillery
{
    ...
    class UStructureSeatComponent* RotatorOccupiableComponent;                        // 0x08C0 (size: 0x8)
    class UStructureSeatComponent* OccupiableComponent;                               // 0x08C8 (size: 0x8)
    class UPayloadInstancedStaticMeshComponent* PayloadInstancedStaticMesh;           // 0x08D0 (size: 0x8)
