...
{
    class UBoxComponent* VehicleBlocking2;                                            // 0x07D0 (size: 0x8)
    class UBoxComponent* VehicleBlocking;                                             // 0x07D8 (size: 0x8)
    class UBoxComponent* BelowBlockingB;                                              // 0x07E0 (size: 0x8)
    class UBoxComponent* BelowBlockingA;                                              // 0x07E8 (size: 0x8)
