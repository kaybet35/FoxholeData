...
class ABPCraterLarge_C : public ACrater
{
    ...
    class UBPTrenchBlockerCapsule_C* BPTrenchBlockerCapsule;                          // 0x07E8 (size: 0x8)
    class UStaticMeshComponent* CraterLarge01;                                        // 0x07F0 (size: 0x8)
    class UDecalComponent* Decal;                                                     // 0x07F8 (size: 0x8)
    class UStaticMeshComponent* Floor;                                                // 0x0800 (size: 0x8)
    class UBoxComponent* Hole;                                                        // 0x0808 (size: 0x8)
