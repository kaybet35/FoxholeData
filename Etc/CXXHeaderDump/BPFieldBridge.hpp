...
class ABPFieldBridge_C : public AFieldBridge
{
    ...
    class UBoxComponent* RampFrontBuildFootprint;                                     // 0x0828 (size: 0x8)
    ...
    class USceneComponent* SandbagTarget;                                             // 0x0848 (size: 0x8)
    class USplineConnectorComponent* SplineComponent2;                                // 0x0850 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x0858 (size: 0x8)
    class USplineConnectorComponent* Sandbag;                                         // 0x0860 (size: 0x8)
    class UBuildSocketComponent* BackSocket;                                          // 0x0868 (size: 0x8)
    class UBuildSocketComponent* FrontSocket;                                         // 0x0870 (size: 0x8)
    FVector Timeline_0_NewTrack_0_738F45B945E6F66E508CF1BDC736E93C;                   // 0x0878 (size: 0xC)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_738F45B945E6F66E508CF1BDC736E93C; // 0x0884 (size: 0x1)
    class UTimelineComponent* Timeline_0;                                             // 0x0888 (size: 0x8)
