...
class ABPRelicArmouredCar_C : public AArmoredCar
{
    ...
    class USpotLightComponent* SpotLight_R;                                           // 0x1390 (size: 0x8)
    class UStaticMeshComponent* Light_R;                                              // 0x1398 (size: 0x8)
    ...
    class UAudioComponent* VehicleIdle;                                               // 0x13B8 (size: 0x8)
