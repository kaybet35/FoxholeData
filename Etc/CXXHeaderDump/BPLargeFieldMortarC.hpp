#ifndef UE4SS_SDK_BPLargeFieldMortarC_HPP
#define UE4SS_SDK_BPLargeFieldMortarC_HPP

class ABPLargeFieldMortarC_C : public AArtillery
{
    class UTowHitchUseComponent* TowHitchUse;                                         // 0x1340 (size: 0x8)
    class USkeletalMeshComponent* chassis;                                            // 0x1348 (size: 0x8)
    ...
    class USeatExitComponent* DriverExit;                                             // 0x1368 (size: 0x8)
