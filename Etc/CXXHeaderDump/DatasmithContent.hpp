...
{
    EDatasmithAreaLightActorType LightType;                                           // 0x0218 (size: 0x1)
    EDatasmithAreaLightActorShape LightShape;                                         // 0x0219 (size: 0x1)
    FVector2D Dimensions;                                                             // 0x021C (size: 0x8)
    float Intensity;                                                                  // 0x0224 (size: 0x4)
    ELightUnits IntensityUnits;                                                       // 0x0228 (size: 0x1)
    FLinearColor Color;                                                               // 0x022C (size: 0x10)
    float Temperature;                                                                // 0x023C (size: 0x4)
    class UTextureLightProfile* IESTexture;                                           // 0x0240 (size: 0x8)
    bool bUseIESBrightness;                                                           // 0x0248 (size: 0x1)
    float IESBrightnessScale;                                                         // 0x024C (size: 0x4)
    FRotator Rotation;                                                                // 0x0250 (size: 0xC)
    float SourceRadius;                                                               // 0x025C (size: 0x4)
    float SourceLength;                                                               // 0x0260 (size: 0x4)
    float AttenuationRadius;                                                          // 0x0264 (size: 0x4)
    float SpotlightInnerAngle;                                                        // 0x0268 (size: 0x4)
    float SpotlightOuterAngle;                                                        // 0x026C (size: 0x4)

}; // Size: 0x270

class ADatasmithImportedSequencesActor : public AActor
{
    TArray<class ULevelSequence*> ImportedSequences;                                  // 0x0218 (size: 0x10)
...
{
    class UDatasmithScene* Scene;                                                     // 0x0218 (size: 0x8)
    TMap<class FName, class TSoftObjectPtr<AActor>> RelatedActors;                    // 0x0220 (size: 0x50)
...
class UDatasmithImportOptions : public UObject
{
    ...
    FDatasmithImportBaseOptions BaseOptions;                                          // 0x0034 (size: 0x14)
    FDatasmithReimportOptions ReimportOptions;                                        // 0x0048 (size: 0x2)
    FString Filename;                                                                 // 0x0050 (size: 0x10)
    FString FilePath;                                                                 // 0x0060 (size: 0x10)
...
{
    TMap<FName, float> ScalarParameterValues;                                         // 0x0030 (size: 0x50)
    TMap<class FName, class FLinearColor> VectorParameterValues;                      // 0x0080 (size: 0x50)
    TMap<class FName, class TSoftObjectPtr<UTexture>> TextureParameterValues;         // 0x00D0 (size: 0x50)
    FDatasmithStaticParameterSetTemplate StaticParameters;                            // 0x0120 (size: 0x50)
...
class UDatasmithSceneComponentTemplate : public UDatasmithObjectTemplate
{
    ...
    TSet<FName> Tags;                                                                 // 0x0090 (size: 0x50)
