...
class ABPLightTankBaseC_C : public ABPLightTankBase_C
{
    ...
    class UStaticMeshComponent* LightTurret;                                          // 0x13C0 (size: 0x8)
    class USpotLightComponent* SpotLight2;                                            // 0x13C8 (size: 0x8)
    class UParticleSystemComponent* Exhaust;                                          // 0x13D0 (size: 0x8)
    class UStaticMeshComponent* lightL;                                               // 0x13D8 (size: 0x8)
    class UStaticMeshComponent* lightR;                                               // 0x13E0 (size: 0x8)
    class USpotLightComponent* SpotLight;                                             // 0x13E8 (size: 0x8)
    class USpotLightComponent* SpotLight1;                                            // 0x13F0 (size: 0x8)
