...
struct FMovieSceneActorReferenceData : public FMovieSceneChannel
{
    ...
    TArray<FMovieSceneActorReferenceKey> KeyValues;                                   // 0x0030 (size: 0x10)
...
struct FMovieSceneActorReferenceSectionTemplate : public FMovieSceneEvalTemplate
{
    ...
    FMovieSceneActorReferenceData ActorReferenceData;                                 // 0x0048 (size: 0xA0)
...
{
    int32 MaterialIndex;                                                              // 0x0060 (size: 0x4)
...
{
    FMovieSceneEventPtrs Ptrs;                                                        // 0x0000 (size: 0x10)
...
struct FMovieSceneEventPtrs
{
    ...
    class UProperty* BoundObjectProperty;                                             // 0x0008 (size: 0x8)

}; // Size: 0x10

struct FMovieSceneEventRepeaterTemplate : public FMovieSceneEventTemplateBase
{
    FMovieSceneEventPtrs EventToTrigger;                                              // 0x0038 (size: 0x10)
...
{
    class UMaterialParameterCollection* MPC;                                          // 0x0060 (size: 0x8)
...
struct FMovieSceneParameterSectionTemplate : public FMovieSceneEvalTemplate
{
    ...
    TArray<FTransformParameterNameAndCurves> Transforms;                              // 0x0050 (size: 0x10)
...
{
    FMovieSceneActorReferenceData ActorReferenceData;                                 // 0x00E0 (size: 0xA0)
    FIntegralCurve ActorGuidIndexCurve;                                               // 0x0180 (size: 0x80)
    TArray<FString> ActorGuidStrings;                                                 // 0x0200 (size: 0x10)
...
class UMovieSceneAudioSection : public UMovieSceneSection
{
    ...
    bool bSuppressSubtitles;                                                          // 0x0240 (size: 0x1)
    bool bOverrideAttenuation;                                                        // 0x0241 (size: 0x1)
    class USoundAttenuation* AttenuationSettings;                                     // 0x0248 (size: 0x8)
    FMovieSceneAudioSectionOnQueueSubtitles OnQueueSubtitles;                         // 0x0250 (size: 0x10)
    void OnQueueSubtitles(const TArray<FSubtitleCue>& Subtitles, float CueDuration);
    FMovieSceneAudioSectionOnAudioFinished OnAudioFinished;                           // 0x0260 (size: 0x10)
    void OnAudioFinished();
    FMovieSceneAudioSectionOnAudioPlaybackPercent OnAudioPlaybackPercent;             // 0x0270 (size: 0x10)
...
{
    FString ShotDisplayName;                                                          // 0x0150 (size: 0x10)
    FText DisplayName;                                                                // 0x0160 (size: 0x18)
...
{
    FMovieSceneEvent Event;                                                           // 0x00E0 (size: 0x10)
...
{
    TArray<FScalarParameterNameAndCurve> ScalarParameterNamesAndCurves;               // 0x00E0 (size: 0x10)
    TArray<FVectorParameterNameAndCurves> VectorParameterNamesAndCurves;              // 0x00F0 (size: 0x10)
    TArray<FColorParameterNameAndCurves> ColorParameterNamesAndCurves;                // 0x0100 (size: 0x10)
    TArray<FTransformParameterNameAndCurves> TransformParameterNamesAndCurves;        // 0x0110 (size: 0x10)
