...
{
    bool DefaultValue;                                                                // 0x0028 (size: 0x1)
...
{
    TSubclassOf<class UProperty> PropertyType;                                        // 0x0020 (size: 0x8)

}; // Size: 0x28

struct FAIDataProviderValue
{
    class UProperty* CachedProperty;                                                  // 0x0008 (size: 0x8)
...
{
    uint8 bStopAILogicOnUnposses;                                                     // 0x02C8 (size: 0x1)
    uint8 bLOSflag;                                                                   // 0x02C8 (size: 0x1)
    uint8 bSkipExtraLOSChecks;                                                        // 0x02C8 (size: 0x1)
    uint8 bAllowStrafe;                                                               // 0x02C8 (size: 0x1)
    uint8 bWantsPlayerState;                                                          // 0x02C8 (size: 0x1)
    uint8 bSetControlRotationFromPawnOrientation;                                     // 0x02C8 (size: 0x1)
    class UPathFollowingComponent* PathFollowingComponent;                            // 0x02D0 (size: 0x8)
    class UBrainComponent* BrainComponent;                                            // 0x02D8 (size: 0x8)
    class UAIPerceptionComponent* PerceptionComponent;                                // 0x02E0 (size: 0x8)
    class UPawnActionsComponent* ActionsComp;                                         // 0x02E8 (size: 0x8)
    class UBlackboardComponent* Blackboard;                                           // 0x02F0 (size: 0x8)
    class UGameplayTasksComponent* CachedGameplayTasksComponent;                      // 0x02F8 (size: 0x8)
    TSubclassOf<class UNavigationQueryFilter> DefaultNavigationFilterClass;           // 0x0300 (size: 0x8)
    FAIControllerReceiveMoveCompleted ReceiveMoveCompleted;                           // 0x0308 (size: 0x10)
...
{
    class UEnvQuery* QueryTemplate;                                                   // 0x0640 (size: 0x8)
    TArray<FEnvNamedValue> QueryParams;                                               // 0x0648 (size: 0x10)
    TArray<FAIDynamicParam> QueryConfig;                                              // 0x0658 (size: 0x10)
    float TimeLimitPerStep;                                                           // 0x0668 (size: 0x4)
    int32 StepToDebugDraw;                                                            // 0x066C (size: 0x4)
    EEnvQueryHightlightMode HighlightMode;                                            // 0x0670 (size: 0x1)
    uint8 bDrawLabels;                                                                // 0x0674 (size: 0x1)
    uint8 bDrawFailedItems;                                                           // 0x0674 (size: 0x1)
    uint8 bReRunQueryOnlyOnFinishedMove;                                              // 0x0674 (size: 0x1)
    uint8 bShouldBeVisibleInGame;                                                     // 0x0674 (size: 0x1)
    uint8 bTickDuringGame;                                                            // 0x0674 (size: 0x1)
    TEnumAsByte<EEnvQueryRunMode::Type> QueryingMode;                                 // 0x0678 (size: 0x1)
    FNavAgentProperties NavAgentProperties;                                           // 0x0680 (size: 0x30)
...
{
    TArray<FNavigationLink> PointLinks;                                               // 0x0228 (size: 0x10)
    TArray<FNavigationSegmentLink> SegmentLinks;                                      // 0x0238 (size: 0x10)
    class UNavLinkCustomComponent* SmartLinkComp;                                     // 0x0248 (size: 0x8)
    bool bSmartLinkIsRelevant;                                                        // 0x0250 (size: 0x1)
    FNavLinkProxyOnSmartLinkReached OnSmartLinkReached;                               // 0x0258 (size: 0x10)
...
class UAIBlueprintHelperLibrary : public UBlueprintFunctionLibrary
{
    ...
    class APawn* SpawnAIFromClass(class UObject* WorldContextObject, TSubclassOf<class APawn> PawnClass, class UBehaviorTree* BehaviorTree, FVector Location, FRotator Rotation, bool bNoCollisionFail);
...
{
    FAIDamageEvent Event;                                                             // 0x0028 (size: 0x30)
...
class UAISense_Damage : public UAISense
{
    ...
    void ReportDamageEvent(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, FVector EventLocation, FVector HitLocation);
}; // Size: 0x90
...
{
    int32 MaxTracesPerTick;                                                           // 0x0130 (size: 0x4)
    int32 MinQueriesPerTimeSliceCheck;                                                // 0x0134 (size: 0x4)
    double MaxTimeSlicePerTick;                                                       // 0x0138 (size: 0x8)
    float HighImportanceQueryDistanceThreshold;                                       // 0x0140 (size: 0x4)
    float MaxQueryImportance;                                                         // 0x0148 (size: 0x4)
    float SightLimitQueryImportance;                                                  // 0x014C (size: 0x4)
...
class UAISystem : public UAISystemBase
{
    ...
    TEnumAsByte<ECollisionChannel> DefaultSightCollisionChannel;                      // 0x009A (size: 0x1)
...
class UBTDecorator_IsAtLocation : public UBTDecorator_BlackboardBase
{
    ...
    FAIDataProviderFloatValue ParametrizedAcceptableRadius;                           // 0x0098 (size: 0x30)
    FAIDistanceType GeometricDistanceType;                                            // 0x00C8 (size: 0x1)
    uint8 bUseParametrizedRadius;                                                     // 0x00CC (size: 0x1)
    uint8 bUseNavAgentGoalLocation;                                                   // 0x00CC (size: 0x1)
    uint8 bPathFindingBasedTest;                                                      // 0x00CC (size: 0x1)
...
{
    class UBTCompositeNode* RootNode;                                                 // 0x0028 (size: 0x8)
    class UBlackboardData* BlackboardAsset;                                           // 0x0030 (size: 0x8)
    TArray<class UBTDecorator*> RootDecorators;                                       // 0x0038 (size: 0x10)
    TArray<FBTDecoratorLogic> RootDecoratorOps;                                       // 0x0048 (size: 0x10)

}; // Size: 0x60

class UBehaviorTreeComponent : public UBrainComponent
{
    TArray<class UBTNode*> NodeInstances;                                             // 0x0130 (size: 0x10)
...
class UBlackboardComponent : public UActorComponent
{
    ...
    class UBlackboardData* BlackboardAsset;                                           // 0x00B8 (size: 0x8)
    TArray<class UBlackboardKeyType*> KeyInstances;                                   // 0x00E0 (size: 0x10)
...
{
    class UCharacterMovementComponent* CharacterMovement;                             // 0x0260 (size: 0x8)
...
class UEnvQueryGenerator_ActorsOfClass : public UEnvQueryGenerator
{
    ...
    FAIDataProviderBoolValue GenerateOnlyActorsInRadius;                              // 0x0058 (size: 0x30)
    FAIDataProviderFloatValue SearchRadius;                                           // 0x0088 (size: 0x30)
    TSubclassOf<class UEnvQueryContext> SearchCenter;                                 // 0x00B8 (size: 0x8)
...
{
    FAIDataProviderFloatValue AlignedPointsDistance;                                  // 0x0080 (size: 0x30)
    FAIDataProviderFloatValue ConeDegrees;                                            // 0x00B0 (size: 0x30)
    FAIDataProviderFloatValue AngleStep;                                              // 0x00E0 (size: 0x30)
    FAIDataProviderFloatValue Range;                                                  // 0x0110 (size: 0x30)
    TSubclassOf<class UEnvQueryContext> CenterActor;                                  // 0x0140 (size: 0x8)
    uint8 bIncludeContextLocation;                                                    // 0x0148 (size: 0x1)
...
{
    FAIDataProviderFloatValue InnerRadius;                                            // 0x0080 (size: 0x30)
    FAIDataProviderFloatValue OuterRadius;                                            // 0x00B0 (size: 0x30)
    FAIDataProviderIntValue NumberOfRings;                                            // 0x00E0 (size: 0x30)
    FAIDataProviderIntValue PointsPerRing;                                            // 0x0110 (size: 0x30)
    FEnvDirection ArcDirection;                                                       // 0x0140 (size: 0x20)
    FAIDataProviderFloatValue ArcAngle;                                               // 0x0160 (size: 0x30)
    bool bUseSpiralPattern;                                                           // 0x0190 (size: 0x1)
    TSubclassOf<class UEnvQueryContext> Center;                                       // 0x0198 (size: 0x8)
    uint8 bDefineArc;                                                                 // 0x01A0 (size: 0x1)

}; // Size: 0x1A8

class UEnvQueryGenerator_OnCircle : public UEnvQueryGenerator_ProjectedPoints
{
    FAIDataProviderFloatValue CircleRadius;                                           // 0x0080 (size: 0x30)
    FAIDataProviderFloatValue SpaceBetween;                                           // 0x00B0 (size: 0x30)
    FAIDataProviderIntValue NumberOfPoints;                                           // 0x00E0 (size: 0x30)
    EPointOnCircleSpacingMethod PointOnCircleSpacingMethod;                           // 0x0110 (size: 0x1)
    FEnvDirection ArcDirection;                                                       // 0x0118 (size: 0x20)
    FAIDataProviderFloatValue ArcAngle;                                               // 0x0138 (size: 0x30)
    float AngleRadians;                                                               // 0x0168 (size: 0x4)
    TSubclassOf<class UEnvQueryContext> CircleCenter;                                 // 0x0170 (size: 0x8)
    bool bIgnoreAnyContextActorsWhenGeneratingCircle;                                 // 0x0178 (size: 0x1)
    FAIDataProviderFloatValue CircleCenterZOffset;                                    // 0x0180 (size: 0x30)
    FEnvTraceData TraceData;                                                          // 0x01B0 (size: 0x30)
...
{
    FAIDataProviderBoolValue PathToItem;                                              // 0x00E8 (size: 0x30)
    TSubclassOf<class UNavigationQueryFilter> NavigationFilter;                       // 0x0118 (size: 0x8)
    FAIDataProviderFloatValue ScanRangeMultiplier;                                    // 0x0120 (size: 0x30)
...
{
    FAIDataProviderFloatValue GridSize;                                               // 0x0080 (size: 0x30)
    FAIDataProviderFloatValue SpaceBetween;                                           // 0x00B0 (size: 0x30)
...
class UEnvQueryTest : public UEnvQueryNode
{
    ...
    FAIDataProviderBoolValue BoolValue;                                               // 0x0050 (size: 0x30)
    FAIDataProviderFloatValue FloatValueMin;                                          // 0x0080 (size: 0x30)
    FAIDataProviderFloatValue FloatValueMax;                                          // 0x00B0 (size: 0x30)
    TEnumAsByte<EEnvTestScoreEquation::Type> ScoringEquation;                         // 0x00E1 (size: 0x1)
    TEnumAsByte<EEnvQueryTestClamping::Type> ClampMinType;                            // 0x00E2 (size: 0x1)
    TEnumAsByte<EEnvQueryTestClamping::Type> ClampMaxType;                            // 0x00E3 (size: 0x1)
    EEQSNormalizationType NormalizationType;                                          // 0x00E4 (size: 0x1)
    FAIDataProviderFloatValue ScoreClampMin;                                          // 0x00E8 (size: 0x30)
    FAIDataProviderFloatValue ScoreClampMax;                                          // 0x0118 (size: 0x30)
    FAIDataProviderFloatValue ScoringFactor;                                          // 0x0148 (size: 0x30)
    FAIDataProviderFloatValue ReferenceValue;                                         // 0x0178 (size: 0x30)
    bool bDefineReferenceValue;                                                       // 0x01A8 (size: 0x1)
    uint8 bWorkOnFloatValues;                                                         // 0x01B8 (size: 0x1)
...
class UEnvQueryTest_Distance : public UEnvQueryTest
{
    ...
    TSubclassOf<class UEnvQueryContext> DistanceTo;                                   // 0x01C8 (size: 0x8)

}; // Size: 0x1D0

class UEnvQueryTest_Dot : public UEnvQueryTest
{
    FEnvDirection LineA;                                                              // 0x01C0 (size: 0x20)
    FEnvDirection LineB;                                                              // 0x01E0 (size: 0x20)
    EEnvTestDot TestMode;                                                             // 0x0200 (size: 0x1)
    bool bAbsoluteValue;                                                              // 0x0201 (size: 0x1)

}; // Size: 0x208

class UEnvQueryTest_GameplayTags : public UEnvQueryTest
{
    FGameplayTagQuery TagQueryToMatch;                                                // 0x01C0 (size: 0x48)
    bool bUpdatedToUseQuery;                                                          // 0x0208 (size: 0x1)
    EGameplayContainerMatchType TagsToMatch;                                          // 0x0209 (size: 0x1)
    FGameplayTagContainer GameplayTags;                                               // 0x0210 (size: 0x20)

}; // Size: 0x230

class UEnvQueryTest_Overlap : public UEnvQueryTest
{
    FEnvOverlapData OverlapData;                                                      // 0x01C0 (size: 0x20)

}; // Size: 0x1E0

class UEnvQueryTest_Pathfinding : public UEnvQueryTest
{
    TEnumAsByte<EEnvTestPathfinding::Type> TestMode;                                  // 0x01C0 (size: 0x1)
    TSubclassOf<class UEnvQueryContext> Context;                                      // 0x01C8 (size: 0x8)
    FAIDataProviderBoolValue PathFromContext;                                         // 0x01D0 (size: 0x30)
    FAIDataProviderBoolValue SkipUnreachable;                                         // 0x0200 (size: 0x30)
    TSubclassOf<class UNavigationQueryFilter> FilterClass;                            // 0x0230 (size: 0x8)

}; // Size: 0x238

class UEnvQueryTest_PathfindingBatch : public UEnvQueryTest_Pathfinding
{
    FAIDataProviderFloatValue ScanRangeMultiplier;                                    // 0x0238 (size: 0x30)

}; // Size: 0x268

class UEnvQueryTest_Project : public UEnvQueryTest
{
    FEnvTraceData ProjectionData;                                                     // 0x01C0 (size: 0x30)
...
class UEnvQueryTest_Trace : public UEnvQueryTest
{
    ...
    FAIDataProviderBoolValue TraceFromContext;                                        // 0x01F0 (size: 0x30)
    FAIDataProviderFloatValue ItemHeightOffset;                                       // 0x0220 (size: 0x30)
    FAIDataProviderFloatValue ContextHeightOffset;                                    // 0x0250 (size: 0x30)
    TSubclassOf<class UEnvQueryContext> Context;                                      // 0x0280 (size: 0x8)

}; // Size: 0x288

class UEnvQueryTest_Volume : public UEnvQueryTest
{
    TSubclassOf<class UEnvQueryContext> VolumeContext;                                // 0x01C0 (size: 0x8)
    TSubclassOf<class AVolume> VolumeClass;                                           // 0x01C8 (size: 0x8)
    uint8 bDoComplexVolumeTest;                                                       // 0x01D0 (size: 0x1)
...
{
    class UNavLocalGridManager* GridManager;                                          // 0x0258 (size: 0x8)
...
{
    class AActor* GoalActor;                                                          // 0x0098 (size: 0x8)
    FVector GoalLocation;                                                             // 0x00A0 (size: 0xC)
    float AcceptableRadius;                                                           // 0x00AC (size: 0x4)
    TSubclassOf<class UNavigationQueryFilter> FilterClass;                            // 0x00B0 (size: 0x8)
    uint8 bAllowStrafe;                                                               // 0x00B8 (size: 0x1)
    uint8 bFinishOnOverlap;                                                           // 0x00B8 (size: 0x1)
    uint8 bUsePathfinding;                                                            // 0x00B8 (size: 0x1)
    uint8 bAllowPartialPath;                                                          // 0x00B8 (size: 0x1)
    uint8 bProjectGoalToNavigation;                                                   // 0x00B8 (size: 0x1)
    uint8 bUpdatePathToGoal;                                                          // 0x00B8 (size: 0x1)
    uint8 bAbortChildActionOnPathChange;                                              // 0x00B8 (size: 0x1)

}; // Size: 0xE8

class UPawnAction_Repeat : public UPawnAction
{
    class UPawnAction* ActionToRepeat;                                                // 0x0098 (size: 0x8)
    class UPawnAction* RecentActionCopy;                                              // 0x00A0 (size: 0x8)
    TEnumAsByte<EPawnActionFailHandling::Type> ChildFailureHandlingMode;              // 0x00A8 (size: 0x1)

}; // Size: 0xB8

class UPawnAction_Sequence : public UPawnAction
{
    TArray<class UPawnAction*> ActionSequence;                                        // 0x0098 (size: 0x10)
    TEnumAsByte<EPawnActionFailHandling::Type> ChildFailureHandlingMode;              // 0x00A8 (size: 0x1)
    class UPawnAction* RecentActionCopy;                                              // 0x00B0 (size: 0x8)

}; // Size: 0xC0

class UPawnAction_Wait : public UPawnAction
{
    float TimeToWait;                                                                 // 0x0098 (size: 0x4)
