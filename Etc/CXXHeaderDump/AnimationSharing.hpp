...
{
    TWeakObjectPtr<class USkeletalMeshComponent> BaseComponent;                       // 0x0268 (size: 0x8)
    TWeakObjectPtr<class UAnimSequence> AdditiveAnimation;                            // 0x0270 (size: 0x8)
    float Alpha;                                                                      // 0x0278 (size: 0x4)
    bool bStateBool;                                                                  // 0x027C (size: 0x1)
...
class UAnimSharingInstance : public UObject
{
    ...
    class UAnimationSharingStateProcessor* StateProcessor;                            // 0x00A8 (size: 0x8)
    TArray<class UAnimSequence*> UsedAnimationSequences;                              // 0x00E8 (size: 0x10)
    class UEnum* StateEnum;                                                           // 0x0108 (size: 0x8)
    class AActor* SharingActor;                                                       // 0x0110 (size: 0x8)

}; // Size: 0x138

class UAnimSharingStateInstance : public UAnimInstance
{
    class UAnimSequence* AnimationToPlay;                                             // 0x0268 (size: 0x8)
    float PermutationTimeOffset;                                                      // 0x0270 (size: 0x4)
    float PlayRate;                                                                   // 0x0274 (size: 0x4)
    bool bStateBool;                                                                  // 0x0278 (size: 0x1)
    class UAnimSharingInstance* Instance;                                             // 0x0280 (size: 0x8)
...
{
    TWeakObjectPtr<class USkeletalMeshComponent> FromComponent;                       // 0x0268 (size: 0x8)
    TWeakObjectPtr<class USkeletalMeshComponent> ToComponent;                         // 0x0270 (size: 0x8)
    float BlendTime;                                                                  // 0x0278 (size: 0x4)
    bool bBlendBool;                                                                  // 0x027C (size: 0x1)
