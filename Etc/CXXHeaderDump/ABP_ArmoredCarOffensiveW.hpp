...
class UABP_ArmoredCarOffensiveW_C : public USimVehicleGunnerSupportAnimInstance
{
    ...
    FAnimNode_LayeredBoneBlend AnimGraphNode_LayeredBoneBlend_104BC20A41EFF9815E1D4CA5D7FB0532; // 0x0CD8 (size: 0xC0)
    FAnimNode_BlendSpacePlayer AnimGraphNode_BlendSpacePlayer_EF84A6104B057DD536BFE5BD2518C690; // 0x0D98 (size: 0xE0)
    FAnimNode_BlendSpacePlayer AnimGraphNode_BlendSpacePlayer_1673EED04AB7B52F7E7B5A8D8716F6DD; // 0x0E78 (size: 0xE0)
    FAnimNode_TransitionResult AnimGraphNode_TransitionResult_81E5302F4F3760FA5C3A2CA9D6E81894; // 0x0F58 (size: 0x28)
    FAnimNode_TransitionResult AnimGraphNode_TransitionResult_4874711F4C5F2F4821E04083FD5818B0; // 0x0F80 (size: 0x28)
    FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_A2AC20114651C2812BC85AA044FE9CDF; // 0x0FA8 (size: 0x78)
    FAnimNode_StateResult AnimGraphNode_StateResult_7B14E94F44535CB111807A9CD7F92E2B; // 0x1020 (size: 0x30)
    FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_379FE99F448AAE3073BB52A06BB2442C; // 0x1050 (size: 0x78)
    FAnimNode_StateResult AnimGraphNode_StateResult_5072E6DC4897619D1B01B8B3E236FB3D; // 0x10C8 (size: 0x30)
    FAnimNode_StateMachine AnimGraphNode_StateMachine_D8242D4B4B1C090EF30F73AEBA479648; // 0x10F8 (size: 0xB0)
