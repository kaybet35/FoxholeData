...
{
    class UPaperFlipbookComponent* Sprite;                                            // 0x0638 (size: 0x8)

}; // Size: 0x640

class APaperFlipbookActor : public AActor
{
    class UPaperFlipbookComponent* RenderComponent;                                   // 0x0218 (size: 0x8)

}; // Size: 0x220

class APaperGroupedSpriteActor : public AActor
{
    class UPaperGroupedSpriteComponent* RenderComponent;                              // 0x0218 (size: 0x8)

}; // Size: 0x220

class APaperSpriteActor : public AActor
{
    class UPaperSpriteComponent* RenderComponent;                                     // 0x0218 (size: 0x8)

}; // Size: 0x220

class APaperTerrainActor : public AActor
{
    class USceneComponent* DummyRoot;                                                 // 0x0218 (size: 0x8)
    class UPaperTerrainSplineComponent* SplineComponent;                              // 0x0220 (size: 0x8)
    class UPaperTerrainComponent* RenderComponent;                                    // 0x0228 (size: 0x8)

}; // Size: 0x230

class APaperTileMapActor : public AActor
{
    class UPaperTileMapComponent* RenderComponent;                                    // 0x0218 (size: 0x8)

}; // Size: 0x220

class UMaterialExpressionSpriteTextureSampler : public UMaterialExpressionTextureSampleParameter2D
{
    bool bSampleAdditionalTextures;                                                   // 0x00F0 (size: 0x1)
    int32 AdditionalSlotIndex;                                                        // 0x00F4 (size: 0x4)
    FText SlotDisplayName;                                                            // 0x00F8 (size: 0x18)
...
{
    class UPaperFlipbook* SourceFlipbook;                                             // 0x0400 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x0408 (size: 0x8)
    float PlayRate;                                                                   // 0x0410 (size: 0x4)
    uint8 bLooping;                                                                   // 0x0414 (size: 0x1)
    uint8 bReversePlayback;                                                           // 0x0414 (size: 0x1)
    uint8 bPlaying;                                                                   // 0x0414 (size: 0x1)
    float AccumulatedTime;                                                            // 0x0418 (size: 0x4)
    int32 CachedFrameIndex;                                                           // 0x041C (size: 0x4)
    FLinearColor SpriteColor;                                                         // 0x0420 (size: 0x10)
    class UBodySetup* CachedBodySetup;                                                // 0x0430 (size: 0x8)
    FPaperFlipbookComponentOnFinishedPlaying OnFinishedPlaying;                       // 0x0438 (size: 0x10)
...
{
    TArray<class UMaterialInterface*> InstanceMaterials;                              // 0x0400 (size: 0x10)
    TArray<FSpriteInstanceData> PerInstanceSpriteData;                                // 0x0410 (size: 0x10)
...
{
    class UPaperSprite* SourceSprite;                                                 // 0x0400 (size: 0x8)
    class UMaterialInterface* MaterialOverride;                                       // 0x0408 (size: 0x8)
    FLinearColor SpriteColor;                                                         // 0x0410 (size: 0x10)
...
{
    class UPaperTerrainMaterial* TerrainMaterial;                                     // 0x03D8 (size: 0x8)
    bool bClosedSpline;                                                               // 0x03E0 (size: 0x1)
    bool bFilledSpline;                                                               // 0x03E1 (size: 0x1)
    class UPaperTerrainSplineComponent* AssociatedSpline;                             // 0x03E8 (size: 0x8)
    int32 RandomSeed;                                                                 // 0x03F0 (size: 0x4)
    float SegmentOverlapAmount;                                                       // 0x03F4 (size: 0x4)
    FLinearColor TerrainColor;                                                        // 0x03F8 (size: 0x10)
    int32 ReparamStepsPerSegment;                                                     // 0x0408 (size: 0x4)
    TEnumAsByte<ESpriteCollisionMode::Type> SpriteCollisionDomain;                    // 0x040C (size: 0x1)
    float CollisionThickness;                                                         // 0x0410 (size: 0x4)
    class UBodySetup* CachedBodySetup;                                                // 0x0418 (size: 0x8)
...
{
    int32 MapWidth;                                                                   // 0x0400 (size: 0x4)
    int32 MapHeight;                                                                  // 0x0404 (size: 0x4)
    int32 TileWidth;                                                                  // 0x0408 (size: 0x4)
    int32 TileHeight;                                                                 // 0x040C (size: 0x4)
    class UPaperTileSet* DefaultLayerTileSet;                                         // 0x0410 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x0418 (size: 0x8)
    TArray<class UPaperTileLayer*> TileLayers;                                        // 0x0420 (size: 0x10)
    FLinearColor TileMapColor;                                                        // 0x0430 (size: 0x10)
    int32 UseSingleLayerIndex;                                                        // 0x0440 (size: 0x4)
    bool bUseSingleLayer;                                                             // 0x0444 (size: 0x1)
    class UPaperTileMap* TileMap;                                                     // 0x0448 (size: 0x8)
