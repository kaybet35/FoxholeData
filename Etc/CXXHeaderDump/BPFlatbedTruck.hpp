...
class ABPFlatbedTruck_C : public AFlatbedTruck
{
    ...
    class USpotLightComponent* SpotLight_L;                                           // 0x13D8 (size: 0x8)
    class USpotLightComponent* SpotLight_R;                                           // 0x13E0 (size: 0x8)
    class UStaticMeshComponent* Light_L;                                              // 0x13E8 (size: 0x8)
    class UStaticMeshComponent* Light_R;                                              // 0x13F0 (size: 0x8)
    class UParticleSystemComponent* Exhaust;                                          // 0x13F8 (size: 0x8)
    class UAudioComponent* TruckIdle;                                                 // 0x1400 (size: 0x8)
