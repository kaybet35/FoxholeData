...
{
    class UStaticMeshComponent* TopMesh;                                              // 0x0218 (size: 0x8)
    class UTurretLightComponent* TurretLight;                                         // 0x0220 (size: 0x8)
    class UStaticMeshComponent* BaseMesh;                                             // 0x0228 (size: 0x8)
    class USpotLightComponent* Light;                                                 // 0x0230 (size: 0x8)
