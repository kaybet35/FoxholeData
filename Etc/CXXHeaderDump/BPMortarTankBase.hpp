...
class ABPMortarTankBase_C : public ABattleTank
{
    ...
    class UStaticMeshComponent* Light_L;                                              // 0x1388 (size: 0x8)
    class UStaticMeshComponent* Light_R;                                              // 0x1390 (size: 0x8)
    class USpotLightComponent* SpotLight_R;                                           // 0x1398 (size: 0x8)
    ...
    class UVehicleSeatComponent* DriverSeat0;                                         // 0x13D8 (size: 0x8)
