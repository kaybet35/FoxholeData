...
class AWheeledVehicle : public APawn
{
    ...
    class UWheeledVehicleMovementComponent* VehicleMovement;                          // 0x0288 (size: 0x8)
...
{
    class UWheeledVehicleMovementComponent* WheeledVehicleMovementComponent;          // 0x0970 (size: 0x8)
