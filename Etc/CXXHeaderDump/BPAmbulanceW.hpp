...
class ABPAmbulanceW_C : public AAmbulance
{
    ...
    class USkeletalMeshComponent* SK_AmbulanceWBody;                                  // 0x12B8 (size: 0x8)
    class USeatExitComponent* PassengerExit;                                          // 0x12C0 (size: 0x8)
    class USeatExitComponent* DriverExit0;                                            // 0x12C8 (size: 0x8)
    class USeatTriggerComponent* BackTrigger;                                         // 0x12D0 (size: 0x8)
    ...
    class UPointLightComponent* LightRear_R;                                          // 0x1300 (size: 0x8)
    class UStaticMeshComponent* RearLight_R;                                          // 0x1308 (size: 0x8)
    class UStaticMeshComponent* Light_L;                                              // 0x1310 (size: 0x8)
