...
class ABPHalfTrackBaseW_C : public ABPHalfTrackBase_C
{
    ...
    class UStaticMeshComponent* mainBody;                                             // 0x1408 (size: 0x8)
    class USpotLightComponent* SpotLight_R;                                           // 0x1410 (size: 0x8)
    class UStaticMeshComponent* Light_R;                                              // 0x1418 (size: 0x8)
