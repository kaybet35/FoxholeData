...
{
    class UBPBuildFootprintBoxComponent_C* BPBuildFootprintBoxComponent;              // 0x0830 (size: 0x8)
    class UBPLoadingAreaBox_C* BPLoadingAreaBox;                                      // 0x0838 (size: 0x8)
    ...
    class UInstancedStaticMeshComponent* InstancedStaticMesh3;                        // 0x0850 (size: 0x8)
    class UStaticMeshComponent* MaterialTransferStation;                              // 0x0858 (size: 0x8)
    class UInstancedStaticMeshComponent* InstancedStaticMesh2;                        // 0x0860 (size: 0x8)
    class UInstancedStaticMeshComponent* InstancedStaticMesh1;                        // 0x0868 (size: 0x8)
