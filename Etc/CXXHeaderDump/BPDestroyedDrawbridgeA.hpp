...
{
    class UBoxComponent* Box3;                                                        // 0x05E8 (size: 0x8)
    class UBoxComponent* Box2;                                                        // 0x05F0 (size: 0x8)
    class UBoxComponent* Box1;                                                        // 0x05F8 (size: 0x8)
    class UBoxComponent* Box;                                                         // 0x0600 (size: 0x8)
    class UBoxComponent* SuspendedBuildSurfaceB;                                      // 0x0608 (size: 0x8)
    class UBoxComponent* SuspendedBuildSurfaceA;                                      // 0x0610 (size: 0x8)
    class UStaticMeshComponent* SideB;                                                // 0x0618 (size: 0x8)
    class UStaticMeshComponent* SideA;                                                // 0x0620 (size: 0x8)
