...
{
    int32 PlayerIndex;                                                                // 0x03D8 (size: 0x4)
    EControllerHand Hand;                                                             // 0x03DC (size: 0x1)
    FName MotionSource;                                                               // 0x03E0 (size: 0x8)
    uint8 bDisableLowLatencyUpdate;                                                   // 0x03E8 (size: 0x1)
    ETrackingStatus CurrentTrackingStatus;                                            // 0x03EC (size: 0x1)
    bool bDisplayDeviceModel;                                                         // 0x03ED (size: 0x1)
    FName DisplayModelSource;                                                         // 0x03F0 (size: 0x8)
    class UStaticMesh* CustomDisplayMesh;                                             // 0x03F8 (size: 0x8)
    TArray<class UMaterialInterface*> DisplayMeshMaterialOverrides;                   // 0x0400 (size: 0x10)
    class UPrimitiveComponent* DisplayComponent;                                      // 0x0470 (size: 0x8)
