#ifndef UE4SS_SDK_FortCommandChalkboard01_HPP
#define UE4SS_SDK_FortCommandChalkboard01_HPP

class AFortCommandChalkboard01_C : public AModificationTemplate
{
    class UDecalComponent* Decal1;                                                    // 0x0218 (size: 0x8)
    class UStaticMeshComponent* StaticMesh5;                                          // 0x0220 (size: 0x8)
    class UStaticMeshComponent* StaticMesh3;                                          // 0x0228 (size: 0x8)
    class UParticleSystemComponent* ParticleSystem;                                   // 0x0230 (size: 0x8)
    class UParticleSystemComponent* StaticLight;                                      // 0x0238 (size: 0x8)
