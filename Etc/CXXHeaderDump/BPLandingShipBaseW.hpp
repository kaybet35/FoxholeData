...
class ABPLandingShipBaseW_C : public ABPLandingShipBase_C
{
    ...
    class UBoxComponent* NoVehicleVolume;                                             // 0x1518 (size: 0x8)
    class UVehicleSeatComponent* DriverSeat0;                                         // 0x1520 (size: 0x8)
    class UParticleSystemComponent* Exhaust1;                                         // 0x1528 (size: 0x8)
