...
{
    FComboButtonStyle ComboButtonStyle;                                               // 0x0008 (size: 0x3A0)
    FSlateSound PressedSlateSound;                                                    // 0x03A8 (size: 0x18)
    FSlateSound SelectionChangeSlateSound;                                            // 0x03C0 (size: 0x18)
...
struct FComboButtonStyle : public FSlateWidgetStyle
{
    ...
    FSlateBrush MenuBorderBrush;                                                      // 0x0308 (size: 0x88)
    FMargin MenuBorderPadding;                                                        // 0x0390 (size: 0x10)
...
struct FEditableTextBoxStyle : public FSlateWidgetStyle
{
    ...
    FSlateFontInfo Font;                                                              // 0x0238 (size: 0x50)
    FSlateColor ForegroundColor;                                                      // 0x0288 (size: 0x28)
    FSlateColor BackgroundColor;                                                      // 0x02B0 (size: 0x28)
    FSlateColor ReadOnlyForegroundColor;                                              // 0x02D8 (size: 0x28)
    FMargin HScrollBarPadding;                                                        // 0x0300 (size: 0x10)
    FMargin VScrollBarPadding;                                                        // 0x0310 (size: 0x10)
    FScrollBarStyle ScrollBarStyle;                                                   // 0x0320 (size: 0x4D0)

}; // Size: 0x7F0

struct FEditableTextStyle : public FSlateWidgetStyle
{
    FSlateFontInfo Font;                                                              // 0x0008 (size: 0x50)
    FSlateColor ColorAndOpacity;                                                      // 0x0058 (size: 0x28)
    FSlateBrush BackgroundImageSelected;                                              // 0x0080 (size: 0x88)
    FSlateBrush BackgroundImageComposing;                                             // 0x0108 (size: 0x88)
    FSlateBrush CaretImage;                                                           // 0x0190 (size: 0x88)
...
struct FHyperlinkStyle : public FSlateWidgetStyle
{
    ...
    FTextBlockStyle TextStyle;                                                        // 0x0280 (size: 0x268)
    FMargin Padding;                                                                  // 0x04E8 (size: 0x10)

}; // Size: 0x4F8

struct FInlineEditableTextBlockStyle : public FSlateWidgetStyle
{
    FEditableTextBoxStyle EditableTextBoxStyle;                                       // 0x0008 (size: 0x7F0)
    FTextBlockStyle TextStyle;                                                        // 0x07F8 (size: 0x268)
...
{
    FEditableTextBoxStyle TextBoxStyle;                                               // 0x0008 (size: 0x7F0)
    FSlateFontInfo ActiveFontInfo;                                                    // 0x07F8 (size: 0x50)
    FSlateBrush UpArrowImage;                                                         // 0x0848 (size: 0x88)
    FSlateBrush DownArrowImage;                                                       // 0x08D0 (size: 0x88)
    FSlateBrush GlassImage;                                                           // 0x0958 (size: 0x88)
    FSlateBrush ClearImage;                                                           // 0x09E0 (size: 0x88)
    FMargin ImagePadding;                                                             // 0x0A68 (size: 0x10)
    bool bLeftAlignButtons;                                                           // 0x0A78 (size: 0x1)
...
struct FTextBlockStyle : public FSlateWidgetStyle
{
    ...
    FSlateColor SelectedBackgroundColor;                                              // 0x0098 (size: 0x28)
    FLinearColor HighlightColor;                                                      // 0x00C0 (size: 0x10)
    FSlateBrush HighlightShape;                                                       // 0x00D0 (size: 0x88)
    FSlateBrush StrikeBrush;                                                          // 0x0158 (size: 0x88)
    FSlateBrush UnderlineBrush;                                                       // 0x01E0 (size: 0x88)
...
struct FWindowStyle : public FSlateWidgetStyle
{
    ...
    FTextBlockStyle TitleTextStyle;                                                   // 0x09E8 (size: 0x268)
    FSlateBrush ActiveTitleBrush;                                                     // 0x0C50 (size: 0x88)
    FSlateBrush InactiveTitleBrush;                                                   // 0x0CD8 (size: 0x88)
    FSlateBrush FlashTitleBrush;                                                      // 0x0D60 (size: 0x88)
    FSlateColor BackgroundColor;                                                      // 0x0DE8 (size: 0x28)
    FSlateBrush OutlineBrush;                                                         // 0x0E10 (size: 0x88)
    FSlateColor OutlineColor;                                                         // 0x0E98 (size: 0x28)
    FSlateBrush BorderBrush;                                                          // 0x0EC0 (size: 0x88)
    FSlateBrush BackgroundBrush;                                                      // 0x0F48 (size: 0x88)
    FSlateBrush ChildBackgroundBrush;                                                 // 0x0FD0 (size: 0x88)
