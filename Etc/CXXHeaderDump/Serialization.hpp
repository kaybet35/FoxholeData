...
struct FStructSerializerArrayTestStruct
{
    ...
    TArray<FStructSerializerBuiltinTestStruct> StructArray;                           // 0x0040 (size: 0x10)
...
struct FStructSerializerTestStruct
{
    ...
    FStructSerializerArrayTestStruct Arrays;                                          // 0x0170 (size: 0x50)
    FStructSerializerMapTestStruct Maps;                                              // 0x01C0 (size: 0x140)
    FStructSerializerSetTestStruct Sets;                                              // 0x0300 (size: 0x140)
