...
class ABPFortCornerCommon_C : public ATemplate
{
    ...
    class UBuildSocketComponent* AngleFortSocket;                                     // 0x0250 (size: 0x8)
    class UBoxComponent* LandscapeHole;                                               // 0x0258 (size: 0x8)
    class UBuildSocketComponent* BackFortSocket;                                      // 0x0260 (size: 0x8)
    class UBuildSocketComponent* LeftFortSocket;                                      // 0x0268 (size: 0x8)
