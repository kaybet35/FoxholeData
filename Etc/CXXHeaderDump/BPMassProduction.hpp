...
class ABPMassProduction_C : public AMassProductionFactory
{
    ...
    class UPointLightComponent* PointLight2;                                          // 0x0828 (size: 0x8)
    class USpotLightComponent* SpotLight;                                             // 0x0830 (size: 0x8)
    class USpotLightComponent* SpotLight2;                                            // 0x0838 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x0840 (size: 0x8)
    class UStaticMeshComponent* StaticMesh9;                                          // 0x0848 (size: 0x8)
    class UChildActorComponent* ChildActor1;                                          // 0x0850 (size: 0x8)
    class UStaticMeshComponent* StaticMesh8;                                          // 0x0858 (size: 0x8)
    class UStaticMeshComponent* StaticMesh7;                                          // 0x0860 (size: 0x8)
    class UStaticMeshComponent* StaticMesh6;                                          // 0x0868 (size: 0x8)
    ...
    class UStaticMeshComponent* Flag;                                                 // 0x08A8 (size: 0x8)
    class UAudioComponent* ProducingSFX;                                              // 0x08B0 (size: 0x8)
    class UParticleSystemComponent* Smoke;                                            // 0x08B8 (size: 0x8)
    class UDecalComponent* Decal2;                                                    // 0x08C0 (size: 0x8)
    class UPointLightComponent* PointLight1;                                          // 0x08C8 (size: 0x8)
    class UMultiplexedStaticMeshComponent* MultiplexedStaticMesh;                     // 0x08D0 (size: 0x8)
    class UStaticMeshComponent* FactoryMesh;                                          // 0x08D8 (size: 0x8)
    bool bIsProducingSFXActive;                                                       // 0x08E0 (size: 0x1)
