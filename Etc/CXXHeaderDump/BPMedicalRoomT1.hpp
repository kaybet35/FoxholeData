...
class ABPMedicalRoomT1_C : public AHospital
{
    ...
    class UTemplateComponent* FortCommonT1BreachedWalls;                              // 0x0858 (size: 0x8)
    ...
    class UTemplateComponent* MedicalRoomCommon;                                      // 0x0878 (size: 0x8)
    class UStaticMeshComponent* Roof;                                                 // 0x0880 (size: 0x8)
    class UStaticMeshComponent* SideLeft;                                             // 0x0888 (size: 0x8)
