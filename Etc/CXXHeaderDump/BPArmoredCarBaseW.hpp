...
class ABPArmoredCarBaseW_C : public ABPArmoredCarBase_C
{
    ...
    class UVehicleSeatComponent* GunnerSeat1;                                         // 0x1380 (size: 0x8)
    class UParticleSystemComponent* Exhaust_R;                                        // 0x1388 (size: 0x8)
    class UParticleSystemComponent* Exhaust_L;                                        // 0x1390 (size: 0x8)
    class UStaticMeshComponent* Light_L;                                              // 0x1398 (size: 0x8)
