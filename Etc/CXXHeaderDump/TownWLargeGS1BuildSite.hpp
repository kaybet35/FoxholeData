...
{
    class USpawnPointComponent* SpawnPoint2;                                          // 0x0820 (size: 0x8)
    class USpawnPointComponent* SpawnPoint;                                           // 0x0828 (size: 0x8)
    class UCameraComponent* ViewTargetCamera;                                         // 0x0830 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0838 (size: 0x8)
    class UBoxComponent* WorkVolume2;                                                 // 0x0840 (size: 0x8)
