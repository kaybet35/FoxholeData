...
class ABPAmbulanceFlameC_C : public AScoutVehicle
{
    ...
    class UPointLightComponent* LightRear_L;                                          // 0x1310 (size: 0x8)
    class UPointLightComponent* LightRear_R;                                          // 0x1318 (size: 0x8)
    class UStaticMeshComponent* RearLight_L;                                          // 0x1320 (size: 0x8)
    class UStaticMeshComponent* RearLight_R;                                          // 0x1328 (size: 0x8)
    class UStaticMeshComponent* Light_L;                                              // 0x1330 (size: 0x8)
    class UStaticMeshComponent* Light_R;                                              // 0x1338 (size: 0x8)
