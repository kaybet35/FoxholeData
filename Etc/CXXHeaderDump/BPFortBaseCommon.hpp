...
class ABPFortBaseCommon_C : public ATemplate
{
    ...
    class UBPLandscapeCullStaticMeshComponent_C* LandscapeCullFront;                  // 0x0220 (size: 0x8)
    class UBPLandscapeCullStaticMeshComponent_C* LandscapeCull;                       // 0x0228 (size: 0x8)
    class UBoxComponent* LandscapeHoleFront;                                          // 0x0230 (size: 0x8)
