...
class ABPTrainBridgeABuildSite_C : public ADrawbridgeBuildSite
{
    ...
    class UBoxComponent* VehicleBlocking2;                                            // 0x0808 (size: 0x8)
    class UBoxComponent* VehicleBlocking;                                             // 0x0810 (size: 0x8)
    class UStaticMeshComponent* SideB;                                                // 0x0818 (size: 0x8)
    class UStaticMeshComponent* SideA;                                                // 0x0820 (size: 0x8)
