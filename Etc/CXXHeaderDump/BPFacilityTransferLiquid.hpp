...
class ABPFacilityTransferLiquid_C : public ALiquidTransferStation
{
    ...
    class UBPStructurePipelineOutput_C* PipeOutput0;                                  // 0x0848 (size: 0x8)
    class UDecalComponent* FoundationDecal;                                           // 0x0850 (size: 0x8)
    class UTemplateComponent* BPFuelLightTemplate;                                    // 0x0858 (size: 0x8)
    class UBPStructurePipelineInput_C* PipeInput0;                                    // 0x0860 (size: 0x8)
    class UStaticMeshComponent* MainMesh;                                             // 0x0868 (size: 0x8)
