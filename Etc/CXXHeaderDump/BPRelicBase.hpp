...
class ABPRelicBase_C : public ARelicBase
{
    ...
    class UStaticMeshComponent* Flag4;                                                // 0x08C8 (size: 0x8)
    class UStaticMeshComponent* Flag3;                                                // 0x08D0 (size: 0x8)
    class UStaticMeshComponent* Flag2;                                                // 0x08D8 (size: 0x8)
    class UStaticMeshComponent* Flag;                                                 // 0x08E0 (size: 0x8)
    class UCameraComponent* ViewTargetCamera;                                         // 0x08E8 (size: 0x8)
