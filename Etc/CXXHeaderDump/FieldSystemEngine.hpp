...
{
    class UFieldSystemComponent* FieldSystemComponent;                                // 0x0218 (size: 0x8)
...
{
    class UFieldSystem* FieldSystem;                                                  // 0x03D8 (size: 0x8)
    TArray<TSoftObjectPtr<AChaosSolverActor>> SupportedSolvers;                       // 0x03F0 (size: 0x10)
