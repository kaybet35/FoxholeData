...
class ABPMedicalRoomT3_C : public AHospital
{
    ...
    class UTemplateComponent* FortLadderComponent;                                    // 0x0830 (size: 0x8)
    class UTemplateComponent* FortCommonT2T3ModsMinimal;                              // 0x0838 (size: 0x8)
    class UTemplateComponent* FortCommonDefenseMods;                                  // 0x0840 (size: 0x8)
    class UBPFortUnderModSlot_C* UnderModSlot;                                        // 0x0848 (size: 0x8)
    class UBPFortWallModSlotMinimal_C* BackModSlot;                                   // 0x0850 (size: 0x8)
    class UBPFortWallModSlotMinimal_C* RightModSlot;                                  // 0x0858 (size: 0x8)
    class UBPFortWallModSlotMinimal_C* FrontModSlot;                                  // 0x0860 (size: 0x8)
    class UTemplateComponent* FortCommon;                                             // 0x0868 (size: 0x8)
    class UStaticMeshComponent* MedicalRoomMesh;                                      // 0x0870 (size: 0x8)
    ...
    class UStaticMeshComponent* DirtRight;                                            // 0x08A8 (size: 0x8)
    class UStaticMeshComponent* DirtBack;                                             // 0x08B0 (size: 0x8)
    class UStaticMeshComponent* DirtLeft;                                             // 0x08B8 (size: 0x8)
    class UStaticMeshComponent* DirtFront;                                            // 0x08C0 (size: 0x8)
