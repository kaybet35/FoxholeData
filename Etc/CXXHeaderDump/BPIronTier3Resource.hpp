...
class ABPIronTier3Resource_C : public AResource
{
    ...
    FVector Timeline_0_NewTrack_0_E3EB68194880B8D36AF392ABBDC88D1C;                   // 0x02C8 (size: 0xC)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_E3EB68194880B8D36AF392ABBDC88D1C; // 0x02D4 (size: 0x1)
