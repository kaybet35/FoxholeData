...
{
    FPoseLink BasePose;                                                               // 0x0140 (size: 0x10)
    int32 LODThreshold;                                                               // 0x0150 (size: 0x4)
    FName SourceSocketName;                                                           // 0x0154 (size: 0x8)
    FName PivotSocketName;                                                            // 0x015C (size: 0x8)
    FVector LookAtLocation;                                                           // 0x0164 (size: 0xC)
    FVector SocketAxis;                                                               // 0x0170 (size: 0xC)
    float Alpha;                                                                      // 0x017C (size: 0x4)
...
{
    float NormalizedTime;                                                             // 0x00E0 (size: 0x4)

}; // Size: 0xE8

struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
    float X;                                                                          // 0x0030 (size: 0x4)
    float Y;                                                                          // 0x0034 (size: 0x4)
    float Z;                                                                          // 0x0038 (size: 0x4)
    float PlayRate;                                                                   // 0x003C (size: 0x4)
    bool bLoop;                                                                       // 0x0040 (size: 0x1)
    bool bResetPlayTimeWhenBlendSpaceChanges;                                         // 0x0041 (size: 0x1)
    float StartPosition;                                                              // 0x0044 (size: 0x4)
    class UBlendSpaceBase* BlendSpace;                                                // 0x0048 (size: 0x8)
    class UBlendSpaceBase* PreviousBlendSpace;                                        // 0x00D8 (size: 0x8)
...
struct FAnimNode_CopyPoseFromMesh : public FAnimNode_Base
{
    ...
    bool bCopyCurves;                                                                 // 0x0019 (size: 0x1)
...
{
    FPoseLink SourcePose;                                                             // 0x0078 (size: 0x10)
    EAlphaBlendOption BlendOption;                                                    // 0x0088 (size: 0x1)
    class UCurveFloat* CustomCurve;                                                   // 0x0090 (size: 0x8)

}; // Size: 0x98

struct FAnimNode_PoseByName : public FAnimNode_PoseHandler
{
    FName PoseName;                                                                   // 0x0078 (size: 0x8)
    float PoseWeight;                                                                 // 0x0080 (size: 0x4)
...
{
    FPoseLink SourcePose;                                                             // 0x0078 (size: 0x10)
    TArray<FBoneReference> SourceBones;                                               // 0x0088 (size: 0x10)
    TArray<FBoneReference> OnlyDriveBones;                                            // 0x0098 (size: 0x10)
    TArray<FPoseDriverTarget> PoseTargets;                                            // 0x00A8 (size: 0x10)
    FBoneReference EvalSpaceBone;                                                     // 0x00E8 (size: 0x10)
    FRBFParams RBFParams;                                                             // 0x00F8 (size: 0x28)
    EPoseDriverSource DriveSource;                                                    // 0x0120 (size: 0x1)
    EPoseDriverOutput DriveOutput;                                                    // 0x0121 (size: 0x1)
    uint8 bOnlyDriveSelectedBones;                                                    // 0x0122 (size: 0x1)

}; // Size: 0x128

struct FAnimNode_PoseHandler : public FAnimNode_AssetPlayerBase
{
    class UPoseAsset* PoseAsset;                                                      // 0x0030 (size: 0x8)
...
struct FAnimNode_RandomPlayer : public FAnimNode_Base
{
    ...
    bool bShuffleMode;                                                                // 0x0064 (size: 0x1)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
    ...
    float CachedBoundsScale;                                                          // 0x01A4 (size: 0x4)
    FBoneReference BaseBoneRef;                                                       // 0x01A8 (size: 0x10)
    TEnumAsByte<ECollisionChannel> OverlapChannel;                                    // 0x01B8 (size: 0x1)
    ESimulationSpace SimulationSpace;                                                 // 0x01B9 (size: 0x1)
    bool bForceDisableCollisionBetweenConstraintBodies;                               // 0x01BA (size: 0x1)
    uint8 bEnableWorldGeometry;                                                       // 0x01BC (size: 0x1)
    uint8 bOverrideWorldGravity;                                                      // 0x01BC (size: 0x1)
    uint8 bTransferBoneVelocities;                                                    // 0x01BC (size: 0x1)
    uint8 bFreezeIncomingPoseOnStart;                                                 // 0x01BC (size: 0x1)
    uint8 bClampLinearTranslationLimitToRefPose;                                      // 0x01BC (size: 0x1)
...
{
    class UPhysicsAsset* OverridePhysicsAsset;                                        // 0x00C8 (size: 0x8)
    FVector OverrideWorldGravity;                                                     // 0x00D0 (size: 0xC)
    FVector ExternalForce;                                                            // 0x00DC (size: 0xC)
    FVector ComponentLinearAccScale;                                                  // 0x00E8 (size: 0xC)
    FVector ComponentLinearVelScale;                                                  // 0x00F4 (size: 0xC)
    FVector ComponentAppliedLinearAccClamp;                                           // 0x0100 (size: 0xC)
    float CachedBoundsScale;                                                          // 0x010C (size: 0x4)
    FBoneReference BaseBoneRef;                                                       // 0x0110 (size: 0x10)
    TEnumAsByte<ECollisionChannel> OverlapChannel;                                    // 0x0120 (size: 0x1)
    ESimulationSpace SimulationSpace;                                                 // 0x0121 (size: 0x1)
    bool bForceDisableCollisionBetweenConstraintBodies;                               // 0x0122 (size: 0x1)
    uint8 bEnableWorldGeometry;                                                       // 0x0123 (size: 0x1)
    uint8 bOverrideWorldGravity;                                                      // 0x0123 (size: 0x1)
    uint8 bTransferBoneVelocities;                                                    // 0x0123 (size: 0x1)
    uint8 bFreezeIncomingPoseOnStart;                                                 // 0x0123 (size: 0x1)
    uint8 bClampLinearTranslationLimitToRefPose;                                      // 0x0123 (size: 0x1)
...
{
    FPoseLink BasePose;                                                               // 0x00E0 (size: 0x10)
    int32 LODThreshold;                                                               // 0x00F0 (size: 0x4)
    float Alpha;                                                                      // 0x00F4 (size: 0x4)
    FInputScaleBias AlphaScaleBias;                                                   // 0x00F8 (size: 0x8)
    FInputAlphaBoolBlend AlphaBoolBlend;                                              // 0x0100 (size: 0x48)
    FName AlphaCurveName;                                                             // 0x0148 (size: 0x8)
    FInputScaleBiasClamp AlphaScaleBiasClamp;                                         // 0x0150 (size: 0x30)
    EAnimAlphaInputType AlphaInputType;                                               // 0x0184 (size: 0x1)
    bool bAlphaBoolEnabled;                                                           // 0x0185 (size: 0x1)
...
{
    class UAnimSequenceBase* Sequence;                                                // 0x0030 (size: 0x8)
    float ExplicitTime;                                                               // 0x0038 (size: 0x4)
    bool bShouldLoop;                                                                 // 0x003C (size: 0x1)
    bool bTeleportToExplicitTime;                                                     // 0x003D (size: 0x1)
    TEnumAsByte<ESequenceEvalReinit::Type> ReinitializationBehavior;                  // 0x003E (size: 0x1)
    float StartPosition;                                                              // 0x0040 (size: 0x4)
...
struct FRBFParams
{
    ...
    ERBFNormalizeMethod NormalizeMethod;                                              // 0x0010 (size: 0x1)
    FVector MedianReference;                                                          // 0x0014 (size: 0xC)
    float MedianMin;                                                                  // 0x0020 (size: 0x4)
    float MedianMax;                                                                  // 0x0024 (size: 0x4)
