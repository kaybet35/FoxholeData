...
{
    int32 BufferSizePerChunk;                                                         // 0x0300 (size: 0x4)
...
{
    TArray<uint8> PreviewImageData;                                                   // 0x0278 (size: 0x10)
    TArray<uint8> ARWorldData;                                                        // 0x0288 (size: 0x10)
    int32 PreviewImageBytesTotal;                                                     // 0x0298 (size: 0x4)
    int32 ARWorldBytesTotal;                                                          // 0x029C (size: 0x4)
    int32 PreviewImageBytesDelivered;                                                 // 0x02A0 (size: 0x4)
    int32 ARWorldBytesDelivered;                                                      // 0x02A4 (size: 0x4)
...
{
    class UAREnvironmentCaptureProbe* CaptureProbe;                                   // 0x0228 (size: 0x8)
...
{
    EARTextureType TextureType;                                                       // 0x0128 (size: 0x1)
    float Timestamp;                                                                  // 0x012C (size: 0x4)
    FGuid ExternalTextureGuid;                                                        // 0x0130 (size: 0x10)
    FVector2D Size;                                                                   // 0x0140 (size: 0x8)
...
{
    EARTextureType TextureType;                                                       // 0x00D0 (size: 0x1)
    float Timestamp;                                                                  // 0x00D4 (size: 0x4)
    FGuid ExternalTextureGuid;                                                        // 0x00D8 (size: 0x10)
    FVector2D Size;                                                                   // 0x00E8 (size: 0x8)

}; // Size: 0xF0

class UARTextureCameraDepth : public UARTexture
{
    EARDepthQuality DepthQuality;                                                     // 0x00F0 (size: 0x1)
    EARDepthAccuracy DepthAccuracy;                                                   // 0x00F1 (size: 0x1)
    bool bIsTemporallySmoothed;                                                       // 0x00F2 (size: 0x1)
