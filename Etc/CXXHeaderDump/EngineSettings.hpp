...
class UGeneralProjectSettings : public UObject
{
    ...
    bool bStartInAR;                                                                  // 0x010B (size: 0x1)
    bool bSupportAR;                                                                  // 0x010C (size: 0x1)
    bool bAllowWindowResize;                                                          // 0x010D (size: 0x1)
    bool bAllowClose;                                                                 // 0x010E (size: 0x1)
    bool bAllowMaximize;                                                              // 0x010F (size: 0x1)
    bool bAllowMinimize;                                                              // 0x0110 (size: 0x1)
