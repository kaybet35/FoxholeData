...
class ABPAmmoRoomT3_C : public AAmmoRoom
{
    ...
    class UInstancedStaticMeshComponent* InstancedStaticMesh;                         // 0x0868 (size: 0x8)
    class UItemGroupRenderComponent* ItemGroupRender;                                 // 0x0870 (size: 0x8)
    ...
    class UStaticMeshComponent* AmmoRoom;                                             // 0x0890 (size: 0x8)
    class UParticleSystemComponent* ParticleSystem;                                   // 0x0898 (size: 0x8)
