#ifndef UE4SS_SDK_FortSupportRadiator01_HPP
#define UE4SS_SDK_FortSupportRadiator01_HPP

class AFortSupportRadiator01_C : public AModificationTemplate
{
    class UStaticMeshComponent* StaticMesh12;                                         // 0x0218 (size: 0x8)
    class UStaticMeshComponent* StaticMesh11;                                         // 0x0220 (size: 0x8)
    class UStaticMeshComponent* StaticMesh10;                                         // 0x0228 (size: 0x8)
    class UStaticMeshComponent* StaticMesh9;                                          // 0x0230 (size: 0x8)
    ...
    class UStaticMeshComponent* StaticMesh5;                                          // 0x0260 (size: 0x8)
    ...
    class UBoxComponent* Collision;                                                   // 0x0280 (size: 0x8)
