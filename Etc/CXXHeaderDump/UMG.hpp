...
{
    FMovieSceneFloatChannel Translation;                                              // 0x0048 (size: 0x140)
    FMovieSceneFloatChannel Rotation;                                                 // 0x0188 (size: 0xA0)
    FMovieSceneFloatChannel Scale;                                                    // 0x0228 (size: 0x140)
    FMovieSceneFloatChannel Shear;                                                    // 0x0368 (size: 0x140)
    EMovieSceneBlendType BlendType;                                                   // 0x04A8 (size: 0x1)
    FMovieScene2DTransformMask Mask;                                                  // 0x04AC (size: 0x4)

}; // Size: 0x4B0

struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
    FMovieSceneFloatChannel TopCurve;                                                 // 0x0048 (size: 0xA0)
    FMovieSceneFloatChannel LeftCurve;                                                // 0x00E8 (size: 0xA0)
    FMovieSceneFloatChannel RightCurve;                                               // 0x0188 (size: 0xA0)
    FMovieSceneFloatChannel BottomCurve;                                              // 0x0228 (size: 0xA0)
...
{
    TArray<FName> BrushPropertyNamePath;                                              // 0x0060 (size: 0x10)
...
{
    FTextBlockStyle TextStyle;                                                        // 0x0008 (size: 0x268)
...
class UCheckBox : public UContentWidget
{
    ...
    bool IsFocusable;                                                                 // 0x0748 (size: 0x1)
...
class UComboBoxString : public UWidget
{
    ...
    FComboBoxStyle WidgetStyle;                                                       // 0x0128 (size: 0x3D8)
    FTableRowStyle ItemStyle;                                                         // 0x0500 (size: 0x7C8)
    FMargin ContentPadding;                                                           // 0x0CC8 (size: 0x10)
    float MaxListHeight;                                                              // 0x0CD8 (size: 0x4)
    bool HasDownArrow;                                                                // 0x0CDC (size: 0x1)
    bool EnableGamepadNavigationMode;                                                 // 0x0CDD (size: 0x1)
    FSlateFontInfo Font;                                                              // 0x0CE0 (size: 0x50)
    FSlateColor ForegroundColor;                                                      // 0x0D30 (size: 0x28)
    bool bIsFocusable;                                                                // 0x0D58 (size: 0x1)
    FComboBoxStringOnGenerateWidgetEvent OnGenerateWidgetEvent;                       // 0x0D5C (size: 0x10)
    class UWidget* GenerateWidgetForString(FString Item);
    FComboBoxStringOnSelectionChanged OnSelectionChanged;                             // 0x0D70 (size: 0x10)
    void OnSelectionChangedEvent(FString SelectedItem, TEnumAsByte<ESelectInfo::Type> SelectionType);
    FComboBoxStringOnOpening OnOpening;                                               // 0x0D80 (size: 0x10)
    void OnOpeningEvent();
...
{
    TSubclassOf<class UUserWidget> EntryWidgetClass;                                  // 0x01C8 (size: 0x8)
...
class UDynamicEntryBoxBase : public UWidget
{
    ...
    FUserWidgetPool EntryWidgetPool;                                                  // 0x0148 (size: 0x80)
...
class UEditableText : public UWidget
{
    ...
    FText GetText();
    FEditableTextStyle WidgetStyle;                                                   // 0x0158 (size: 0x218)
    class USlateWidgetStyleAsset* Style;                                              // 0x0370 (size: 0x8)
    class USlateBrushAsset* BackgroundImageSelected;                                  // 0x0378 (size: 0x8)
    class USlateBrushAsset* BackgroundImageComposing;                                 // 0x0380 (size: 0x8)
    class USlateBrushAsset* CaretImage;                                               // 0x0388 (size: 0x8)
    FSlateFontInfo Font;                                                              // 0x0390 (size: 0x50)
    FSlateColor ColorAndOpacity;                                                      // 0x03E0 (size: 0x28)
    bool IsReadOnly;                                                                  // 0x0408 (size: 0x1)
    bool IsPassword;                                                                  // 0x0409 (size: 0x1)
    float MinimumDesiredWidth;                                                        // 0x040C (size: 0x4)
    bool IsCaretMovedWhenGainFocus;                                                   // 0x0410 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x0411 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x0412 (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x0413 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x0414 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x0415 (size: 0x1)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x0416 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x0417 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0418 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0419 (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x041A (size: 0x3)
    FEditableTextOnTextChanged OnTextChanged;                                         // 0x0420 (size: 0x10)
    void OnEditableTextChangedEvent(const FText& Text);
    FEditableTextOnTextCommitted OnTextCommitted;                                     // 0x0430 (size: 0x10)
...
class UEditableTextBox : public UWidget
{
    ...
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x0130 (size: 0x7F0)
    class USlateWidgetStyleAsset* Style;                                              // 0x0920 (size: 0x8)
    FText HintText;                                                                   // 0x0928 (size: 0x18)
    FEditableTextBoxHintTextDelegate HintTextDelegate;                                // 0x0940 (size: 0x10)
    FText GetText();
    FSlateFontInfo Font;                                                              // 0x0950 (size: 0x50)
    FLinearColor ForegroundColor;                                                     // 0x09A0 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x09B0 (size: 0x10)
    FLinearColor ReadOnlyForegroundColor;                                             // 0x09C0 (size: 0x10)
    bool IsReadOnly;                                                                  // 0x09D0 (size: 0x1)
    bool IsPassword;                                                                  // 0x09D1 (size: 0x1)
    float MinimumDesiredWidth;                                                        // 0x09D4 (size: 0x4)
    FMargin Padding;                                                                  // 0x09D8 (size: 0x10)
    bool IsCaretMovedWhenGainFocus;                                                   // 0x09E8 (size: 0x1)
    bool SelectAllTextWhenFocused;                                                    // 0x09E9 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x09EA (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x09EB (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x09EC (size: 0x1)
    bool AllowContextMenu;                                                            // 0x09ED (size: 0x1)
    TEnumAsByte<EVirtualKeyboardType::Type> KeyboardType;                             // 0x09EE (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x09EF (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x09F0 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x09F1 (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x09F2 (size: 0x3)
    FEditableTextBoxOnTextChanged OnTextChanged;                                      // 0x09F8 (size: 0x10)
    void OnEditableTextBoxChangedEvent(const FText& Text);
    FEditableTextBoxOnTextCommitted OnTextCommitted;                                  // 0x0A08 (size: 0x10)
...
class UInputKeySelector : public UWidget
{
    ...
    FTextBlockStyle TextStyle;                                                        // 0x0380 (size: 0x268)
    FInputChord SelectedKey;                                                          // 0x05E8 (size: 0x20)
    FSlateFontInfo Font;                                                              // 0x0608 (size: 0x50)
    FMargin Margin;                                                                   // 0x0658 (size: 0x10)
    FLinearColor ColorAndOpacity;                                                     // 0x0668 (size: 0x10)
    FText KeySelectionText;                                                           // 0x0678 (size: 0x18)
    FText NoKeySpecifiedText;                                                         // 0x0690 (size: 0x18)
    bool bAllowModifierKeys;                                                          // 0x06A8 (size: 0x1)
    bool bAllowGamepadKeys;                                                           // 0x06A9 (size: 0x1)
    TArray<FKey> EscapeKeys;                                                          // 0x06B0 (size: 0x10)
    FInputKeySelectorOnKeySelected OnKeySelected;                                     // 0x06C0 (size: 0x10)
    void OnKeySelected(FInputChord SelectedKey);
    FInputKeySelectorOnIsSelectingKeyChanged OnIsSelectingKeyChanged;                 // 0x06D0 (size: 0x10)
...
class UMenuAnchor : public UContentWidget
{
    ...
    TEnumAsByte<EMenuPlacement> Placement;                                            // 0x0138 (size: 0x1)
    bool bFitInWindow;                                                                // 0x0139 (size: 0x1)
    bool ShouldDeferPaintingAfterWindowContent;                                       // 0x013A (size: 0x1)
    bool UseApplicationMenuStack;                                                     // 0x013B (size: 0x1)
    FMenuAnchorOnMenuOpenChanged OnMenuOpenChanged;                                   // 0x0140 (size: 0x10)
...
{
    FMovieScene2DTransformMask TransformMask;                                         // 0x00E0 (size: 0x4)
    FMovieSceneFloatChannel Translation;                                              // 0x00E8 (size: 0x140)
    FMovieSceneFloatChannel Rotation;                                                 // 0x0228 (size: 0xA0)
    FMovieSceneFloatChannel Scale;                                                    // 0x02C8 (size: 0x140)
    FMovieSceneFloatChannel Shear;                                                    // 0x0408 (size: 0x140)
...
{
    FMovieSceneFloatChannel TopCurve;                                                 // 0x00E0 (size: 0xA0)
    FMovieSceneFloatChannel LeftCurve;                                                // 0x0180 (size: 0xA0)
    FMovieSceneFloatChannel RightCurve;                                               // 0x0220 (size: 0xA0)
    FMovieSceneFloatChannel BottomCurve;                                              // 0x02C0 (size: 0xA0)
...
{
    TArray<FName> BrushPropertyNamePath;                                              // 0x0068 (size: 0x10)
    FName TrackName;                                                                  // 0x0078 (size: 0x8)
...
class UMultiLineEditableText : public UTextLayoutWidget
{
    ...
    FText GetText();
    FTextBlockStyle WidgetStyle;                                                      // 0x0168 (size: 0x268)
    bool bIsReadOnly;                                                                 // 0x03D0 (size: 0x1)
    FSlateFontInfo Font;                                                              // 0x03D8 (size: 0x50)
    bool SelectAllTextWhenFocused;                                                    // 0x0428 (size: 0x1)
    bool ClearTextSelectionOnFocusLoss;                                               // 0x0429 (size: 0x1)
    bool RevertTextOnEscape;                                                          // 0x042A (size: 0x1)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x042B (size: 0x1)
    bool AllowContextMenu;                                                            // 0x042C (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x042D (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x042E (size: 0x1)
    FMultiLineEditableTextOnTextChanged OnTextChanged;                                // 0x0430 (size: 0x10)
    void OnMultiLineEditableTextChangedEvent(const FText& Text);
    FMultiLineEditableTextOnTextCommitted OnTextCommitted;                            // 0x0440 (size: 0x10)
...
class UMultiLineEditableTextBox : public UTextLayoutWidget
{
    ...
    FText GetText();
    FEditableTextBoxStyle WidgetStyle;                                                // 0x0168 (size: 0x7F0)
    FTextBlockStyle TextStyle;                                                        // 0x0958 (size: 0x268)
    bool bIsReadOnly;                                                                 // 0x0BC0 (size: 0x1)
    bool AllowContextMenu;                                                            // 0x0BC1 (size: 0x1)
    FVirtualKeyboardOptions VirtualKeyboardOptions;                                   // 0x0BC2 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0BC3 (size: 0x1)
    class USlateWidgetStyleAsset* Style;                                              // 0x0BC8 (size: 0x8)
    FSlateFontInfo Font;                                                              // 0x0BD0 (size: 0x50)
    FLinearColor ForegroundColor;                                                     // 0x0C20 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x0C30 (size: 0x10)
    FLinearColor ReadOnlyForegroundColor;                                             // 0x0C40 (size: 0x10)
    FMultiLineEditableTextBoxOnTextChanged OnTextChanged;                             // 0x0C50 (size: 0x10)
    void OnMultiLineEditableTextBoxChangedEvent(const FText& Text);
    FMultiLineEditableTextBoxOnTextCommitted OnTextCommitted;                         // 0x0C60 (size: 0x10)
...
{
    bool RenderOnInvalidation;                                                        // 0x0120 (size: 0x1)
    bool RenderOnPhase;                                                               // 0x0121 (size: 0x1)
...
class URichTextBlock : public UTextLayoutWidget
{
    ...
    FTextBlockStyle DefaultTextStyleOverride;                                         // 0x0160 (size: 0x268)
    float MinDesiredWidth;                                                            // 0x03C8 (size: 0x4)
    TArray<class URichTextBlockDecorator*> InstanceDecorators;                        // 0x0638 (size: 0x10)
...
class UScrollBox : public UPanelWidget
{
    ...
    bool bAllowRightClickDragScrolling;                                               // 0x0850 (size: 0x1)
...
class USpinBox : public UWidget
{
    ...
    float Delta;                                                                      // 0x0410 (size: 0x4)
    float SliderExponent;                                                             // 0x0414 (size: 0x4)
    FSlateFontInfo Font;                                                              // 0x0418 (size: 0x50)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0468 (size: 0x1)
    float MinDesiredWidth;                                                            // 0x046C (size: 0x4)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x0470 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x0471 (size: 0x1)
    FSlateColor ForegroundColor;                                                      // 0x0478 (size: 0x28)
    FSpinBoxOnValueChanged OnValueChanged;                                            // 0x04A0 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    FSpinBoxOnValueCommitted OnValueCommitted;                                        // 0x04B0 (size: 0x10)
    void OnSpinBoxValueCommittedEvent(float InValue, TEnumAsByte<ETextCommit::Type> CommitMethod);
    FSpinBoxOnBeginSliderMovement OnBeginSliderMovement;                              // 0x04C0 (size: 0x10)
    void OnSpinBoxBeginSliderMovement();
    FSpinBoxOnEndSliderMovement OnEndSliderMovement;                                  // 0x04D0 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    uint8 bOverride_MinValue;                                                         // 0x04E0 (size: 0x1)
    uint8 bOverride_MaxValue;                                                         // 0x04E0 (size: 0x1)
    uint8 bOverride_MinSliderValue;                                                   // 0x04E0 (size: 0x1)
    uint8 bOverride_MaxSliderValue;                                                   // 0x04E0 (size: 0x1)
    float MinValue;                                                                   // 0x04E4 (size: 0x4)
    float MaxValue;                                                                   // 0x04E8 (size: 0x4)
    float MinSliderValue;                                                             // 0x04EC (size: 0x4)
    float MaxSliderValue;                                                             // 0x04F0 (size: 0x4)
...
class UTextBlock : public UTextLayoutWidget
{
    ...
    FSlateFontInfo Font;                                                              // 0x0188 (size: 0x50)
    FSlateBrush StrikeBrush;                                                          // 0x01D8 (size: 0x88)
    FVector2D ShadowOffset;                                                           // 0x0260 (size: 0x8)
    FLinearColor ShadowColorAndOpacity;                                               // 0x0268 (size: 0x10)
    FTextBlockShadowColorAndOpacityDelegate ShadowColorAndOpacityDelegate;            // 0x0278 (size: 0x10)
    FLinearColor GetLinearColor();
    float MinDesiredWidth;                                                            // 0x0288 (size: 0x4)
    bool bWrapWithInvalidationPanel;                                                  // 0x028C (size: 0x1)
    bool bAutoWrapText;                                                               // 0x028D (size: 0x1)
    bool bSimpleTextMode;                                                             // 0x028E (size: 0x1)
...
{
    class UWidgetAnimation* Animation;                                                // 0x0408 (size: 0x8)
...
class UUserWidget : public UWidget
{
    ...
    TArray<class UUMGSequencePlayer*> ActiveSequencePlayers;                          // 0x0178 (size: 0x10)
    TArray<class UUMGSequencePlayer*> StoppedSequencePlayers;                         // 0x0188 (size: 0x10)
    TArray<FNamedSlotBinding> NamedSlotBindings;                                      // 0x0198 (size: 0x10)
    class UWidgetTree* WidgetTree;                                                    // 0x01A8 (size: 0x8)
    int32 Priority;                                                                   // 0x01B0 (size: 0x4)
    uint8 bSupportsKeyboardFocus;                                                     // 0x01B4 (size: 0x1)
    uint8 bIsFocusable;                                                               // 0x01B4 (size: 0x1)
    uint8 bStopAction;                                                                // 0x01B4 (size: 0x1)
    uint8 bHasScriptImplementedTick;                                                  // 0x01B4 (size: 0x1)
    uint8 bHasScriptImplementedPaint;                                                 // 0x01B4 (size: 0x1)
    uint8 bCookedWidgetTree;                                                          // 0x01B4 (size: 0x1)
    EWidgetTickFrequency TickFrequency;                                               // 0x01C0 (size: 0x1)
    class UInputComponent* InputComponent;                                            // 0x01C8 (size: 0x8)
    TArray<FAnimationEventBinding> AnimationCallbacks;                                // 0x01D0 (size: 0x10)
...
class UWidgetAnimation : public UMovieSceneSequence
{
    ...
    TArray<FWidgetAnimationBinding> AnimationBindings;                                // 0x0350 (size: 0x10)
    bool bLegacyFinishOnStop;                                                         // 0x0360 (size: 0x1)
    FString DisplayLabel;                                                             // 0x0368 (size: 0x10)
...
{
    class UWidgetTree* WidgetTree;                                                    // 0x0300 (size: 0x8)
    uint8 bAllowTemplate;                                                             // 0x0308 (size: 0x1)
    uint8 bAllowDynamicCreation;                                                      // 0x0308 (size: 0x1)
    uint8 bValidTemplate;                                                             // 0x0308 (size: 0x1)
    uint8 bTemplateInitialized;                                                       // 0x0308 (size: 0x1)
    uint8 bCookedTemplate;                                                            // 0x0308 (size: 0x1)
    uint8 bClassRequiresNativeTick;                                                   // 0x0308 (size: 0x1)
    TArray<FDelegateRuntimeBinding> Bindings;                                         // 0x0310 (size: 0x10)
    TArray<class UWidgetAnimation*> Animations;                                       // 0x0320 (size: 0x10)
    TArray<FName> NamedSlots;                                                         // 0x0330 (size: 0x10)
    TSoftObjectPtr<UUserWidget> TemplateAsset;                                        // 0x0340 (size: 0x28)
    class UUserWidget* Template;                                                      // 0x0368 (size: 0x8)
...
{
    EWidgetSpace Space;                                                               // 0x0400 (size: 0x1)
    EWidgetTimingPolicy TimingPolicy;                                                 // 0x0401 (size: 0x1)
    TSubclassOf<class UUserWidget> WidgetClass;                                       // 0x0408 (size: 0x8)
    FIntPoint DrawSize;                                                               // 0x0410 (size: 0x8)
    bool bManuallyRedraw;                                                             // 0x0418 (size: 0x1)
    bool bRedrawRequested;                                                            // 0x0419 (size: 0x1)
    float RedrawTime;                                                                 // 0x041C (size: 0x4)
    FIntPoint CurrentDrawSize;                                                        // 0x0428 (size: 0x8)
    bool bDrawAtDesiredSize;                                                          // 0x0430 (size: 0x1)
    FVector2D Pivot;                                                                  // 0x0434 (size: 0x8)
    bool bReceiveHardwareInput;                                                       // 0x043C (size: 0x1)
    bool bWindowFocusable;                                                            // 0x043D (size: 0x1)
    EWindowVisibility WindowVisibility;                                               // 0x043E (size: 0x1)
    bool bApplyGammaCorrection;                                                       // 0x043F (size: 0x1)
    class ULocalPlayer* OwnerPlayer;                                                  // 0x0440 (size: 0x8)
    FLinearColor BackgroundColor;                                                     // 0x0448 (size: 0x10)
    FLinearColor TintColorAndOpacity;                                                 // 0x0458 (size: 0x10)
    float OpacityFromTexture;                                                         // 0x0468 (size: 0x4)
    EWidgetBlendMode BlendMode;                                                       // 0x046C (size: 0x1)
    bool bIsTwoSided;                                                                 // 0x046D (size: 0x1)
    bool TickWhenOffscreen;                                                           // 0x046E (size: 0x1)
    class UUserWidget* Widget;                                                        // 0x0470 (size: 0x8)
    class UBodySetup* BodySetup;                                                      // 0x0498 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial;                                    // 0x04A0 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial_OneSided;                           // 0x04A8 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial;                                         // 0x04B0 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial_OneSided;                                // 0x04B8 (size: 0x8)
    class UMaterialInterface* MaskedMaterial;                                         // 0x04C0 (size: 0x8)
    class UMaterialInterface* MaskedMaterial_OneSided;                                // 0x04C8 (size: 0x8)
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x04D0 (size: 0x8)
    class UMaterialInstanceDynamic* MaterialInstance;                                 // 0x04D8 (size: 0x8)
    bool bAddedToScreen;                                                              // 0x04E0 (size: 0x1)
    bool bEditTimeUsable;                                                             // 0x04E1 (size: 0x1)
    FName SharedLayerName;                                                            // 0x04E4 (size: 0x8)
    int32 LayerZOrder;                                                                // 0x04EC (size: 0x4)
    EWidgetGeometryMode GeometryMode;                                                 // 0x04F0 (size: 0x1)
    float CylinderArcAngle;                                                           // 0x04F4 (size: 0x4)
...
{
    FWidgetInteractionComponentOnHoveredWidgetChanged OnHoveredWidgetChanged;         // 0x01F0 (size: 0x10)
    void OnHoveredWidgetChanged(class UWidgetComponent* WidgetComponent, class UWidgetComponent* PreviousWidgetComponent);
    int32 VirtualUserIndex;                                                           // 0x0210 (size: 0x4)
    float PointerIndex;                                                               // 0x0214 (size: 0x4)
    TEnumAsByte<ECollisionChannel> TraceChannel;                                      // 0x0218 (size: 0x1)
    float InteractionDistance;                                                        // 0x021C (size: 0x4)
    EWidgetInteractionSource InteractionSource;                                       // 0x0220 (size: 0x1)
    bool bEnableHitTesting;                                                           // 0x0221 (size: 0x1)
    bool bShowDebug;                                                                  // 0x0222 (size: 0x1)
    FLinearColor DebugColor;                                                          // 0x0224 (size: 0x10)
    FHitResult CustomHitResult;                                                       // 0x02B0 (size: 0x88)
    FVector2D LocalHitLocation;                                                       // 0x0338 (size: 0x8)
    FVector2D LastLocalHitLocation;                                                   // 0x0340 (size: 0x8)
    class UWidgetComponent* HoveredWidgetComponent;                                   // 0x0348 (size: 0x8)
    FHitResult LastHitResult;                                                         // 0x0350 (size: 0x88)
    bool bIsHoveredWidgetInteractable;                                                // 0x03D8 (size: 0x1)
    bool bIsHoveredWidgetFocusable;                                                   // 0x03D9 (size: 0x1)
    bool bIsHoveredWidgetHitTestVisible;                                              // 0x03DA (size: 0x1)
...
class UWrapBox : public UPanelWidget
{
    ...
    bool bExplicitWrapWidth;                                                          // 0x012C (size: 0x1)
