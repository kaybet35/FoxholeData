...
enum class EActorLogEntryType {
    ...
    RetrievePatient = 30,
    ConvertPatient = 31,
    ConstructionBuildStarted = 32,
    ConstructionNotEnoughMaterials = 33,
    ConstructionBelongsToEnemy = 34,
    ConstructionSiteObstructed = 35,
    ConstructionSiteNoLongerExists = 36,
    OtherBuildToolRequired = 37,
    WeaponAttached = 38,
    WeaponDetached = 39,
    Packaged = 40,
    Unpackaged = 41,
    AutoUnpackaged = 42,
    VehicleConstructionComplete = 43,
    VehicleRetrievedFromStockpile = 44,
    VehicleTravelled = 45,
    TrailerAttached = 46,
    TrailerDetached = 47,
    ShippableReceived = 48,
    ShippableRemoved = 49,
    VehicleLocked = 50,
    VehicleUnlocked = 51,
    VehicleWrenched = 52,
    VehicleReserved = 53,
    VehicleReservationRemoved = 54,
    VehicleReserveExpiry = 55,
    ChangedFuelType = 56,
    VehicleFullRepair = 57,
    MAX = 58,
};
