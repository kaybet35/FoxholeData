...
enum class EActivityBonusState {
    None = 0,
    Inactive = 1,
    Active = 2,
...
enum class ETechID {
    ...
    UnlockFort = 74,
    UnlockFortGarrisonStation = 75,
    UnlockFortStaticArtillery = 76,
    UnlockGarrisonBuilding = 77,
    UnlockGateTier2 = 78,
    UnlockGateTier3 = 79,
    UnlockIntelligenceCenter = 80,
    UnlockLongRangeArtillery = 81,
    UnlockMGGarrison = 82,
    UnlockMineSpline = 83,
    UnlockRifleGarrison = 84,
    UnlockRocket = 85,
    UnlockScrapMine = 86,
    UnlockStaticArtillery = 87,
    UnlockSulfurMine = 88,
    UnlockTankStop = 89,
    UnlockTankStopSplineTier3 = 90,
    UnlockTempMS59 = 91,
    UnlockWallTier2 = 92,
    UnlockWallTier3 = 93,
    UnlockWeatherStation = 94,
    UnlockMGPillbox = 95,
    UnlockATPillbox = 96,
    UnlockAmbulance = 97,
    UnlockArmoredCar = 98,
    UnlockArmoredCarAT = 99,
    UnlockArmoredCarFlame = 100,
    UnlockArmoredCarMobility = 101,
    UnlockArmoredCarOffensive = 102,
    UnlockArmoredCarTwin = 103,
    UnlockArmoredCar2Multi = 104,
    UnlockBarge = 105,
    UnlockBattleTank = 106,
    UnlockBattleTankDefensive = 107,
    UnlockBattleTankOffensive = 108,
    UnlockBus = 109,
    UnlockConstructionUtility = 110,
    UnlockDestroyerTank = 111,
    UnlockDestroyerTankFlame = 112,
    UnlockFieldArtillery = 113,
    UnlockFieldATGun = 114,
    UnlockFieldATLarge = 115,
    UnlockFieldATDamageGun = 116,
    UnlockFieldAT2 = 117,
    UnlockFieldCannon = 118,
    UnlockFieldCannonDamage = 119,
    UnlockFieldCannonLarge = 120,
    UnlockFieldMG = 121,
    UnlockFieldMortar = 122,
    UnlockFieldMortarLarge = 123,
    UnlockFieldMulti = 124,
    UnlockFlatbedTruck = 125,
    UnlockFreighter = 126,
    UnlockGunboat = 127,
    UnlockHalfTrack = 128,
    UnlockHalfTrackDefensive = 129,
    UnlockHalfTrackOffensive = 130,
    UnlockHalfTrackArtillery = 131,
    UnlockHalfTrackMulti = 132,
    UnlockHarvester = 133,
    UnlockLandingCraft = 134,
    UnlockLandingCraftOffensive = 135,
    UnlockLargeShipBattleship = 136,
    UnlockLargeShipBaseShip = 137,
    UnlockLargeShipDestroyer = 138,
    UnlockLargeShipResource = 139,
    UnlockLargeShipStorageShip = 140,
    UnlockLargeShipSubmarine = 141,
    UnlockLightTank = 142,
    UnlockLightTank2Infantry = 143,
    UnlockLightTankArtillery = 144,
    UnlockLightTankFlame = 145,
    UnlockLightTankMobility = 146,
    UnlockLightTankDefensive = 147,
    UnlockLightTankOffensive = 148,
    UnlockMech = 149,
    UnlockMediumTank = 150,
    UnlockMediumTankLarge = 151,
    UnlockMediumTank2 = 152,
    UnlockMediumTank2Indirect = 153,
    UnlockMediumTank2Multi = 154,
    UnlockMediumTank2Range = 155,
    UnlockMediumTank2Twin = 156,
    UnlockMediumTank3 = 157,
    UnlockMediumTankOffensive = 158,
    UnlockMediumTankSiege = 159,
    UnlockMortarTank = 160,
    UnlockMotorcycle = 161,
    UnlockMotorcycleOffensive = 162,
    UnlockRelicArmoredCar = 163,
    UnlockRelicLightTank = 164,
    UnlockRelicMediumTank = 165,
    UnlockRelicScoutVehicle = 166,
    UnlockRelicTruck = 167,
    UnlockScoutTank = 168,
    UnlockScoutTankOffensive = 169,
    UnlockScoutTankMulitW = 170,
    UnlockScoutVehicle = 171,
    UnlockScoutVehicleMobility = 172,
    UnlockScoutVehicleOffensive = 173,
    UnlockScoutVehicleUtility = 174,
    UnlockSuperTank = 175,
    UnlockTankette = 176,
    UnlockTanketteFlame = 177,
    UnlockTanketteOffensive = 178,
    UnlockTrainEngine = 179,
    UnlockTruckDefensive = 180,
    UnlockTruckDump = 181,
    UnlockTruckMobility = 182,
    UnlockTruckMulti = 183,
    UnlockTruckOffensive = 184,
    UnlockAdvancedConstruction = 185,
    UnlockFacilityTier2 = 186,
    UnlockFacilityTier3 = 187,
    UnlockAmmoUniform = 188,
    UnlockArmourUniform = 189,
    UnlockChemicalUniform = 190,
    UnlockEngineerUniform = 191,
    UnlockGrenadeUniform = 192,
    UnlockMedicUniform = 193,
    UnlockNavalUniform = 194,
    UnlockOfficerUniform = 195,
    UnlockRainUniform = 196,
    UnlockScoutUniform = 197,
    UnlockSnowUniform = 198,
    UnlockTankUniform = 199,
    UnlockHiddenContent = 200,
    Count = 201,
    ETechID_MAX = 202,
};
