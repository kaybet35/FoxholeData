...
enum class EEquippedWeaponGripType {
    ...
    Shotgun = 48,
    EEquippedWeaponGripType_MAX = 49,
};
...
enum class EFortModificationType {
    ...
    Electric = 36,
    SulfuricReactor = 37,
    IndustrialTurbines = 38,
    SteamTurbine = 39,
    Forge = 40,
    MetalPress = 41,
    Smelter = 42,
    BlastFurnace = 43,
    EngineeringStation = 44,
    Recycler = 45,
    CokeFurnace = 46,
    CoalLiquefier = 47,
    AdvCoalLiquefier = 48,
    Reformer = 49,
    CrackingUnit = 50,
    PetrochemicalPlant = 51,
    MotorPool = 52,
    ArtilleryFactory = 53,
    LightVehicleAssembly = 54,
    TankAssembly = 55,
    WeaponsPlatformAssembly = 56,
    RocketAssembly = 57,
    ShipAssembly = 58,
    TrainAssembly = 59,
    HeavyTankAssembly = 60,
    MachiningStation = 61,
    AdvMachiningStation = 62,
    Light = 63,
    Insulation = 64,
    Count = 65,
    None = 66,
    EFortModificationType_MAX = 67,
};
...
enum class EHUDNotification {
    ...
    EnemiesNearby = 57,
    IslandMustBeRepaired = 58,
    IslandRequirementsMissing = 59,
    CantUnequipUniform = 60,
    ItemsDropped = 61,
    LadderObstructed = 62,
    LadderObstructedByPlayer = 63,
    BridgeVehicleDecayWarning = 64,
    BridgeVehicleDecay = 65,
    ModificationInProgress = 66,
    ItemsSubmitted = 67,
    ItemsEmpty = 68,
    ItemsFailedToSubmit = 69,
    ItemsCantBeSubmitted = 70,
    RailVehicleNotPrimaryLocomotive = 71,
    RailVehicleMultipleDrivers = 72,
    CantAdjustPowerGrid = 73,
    CantAdjustPipeValve = 74,
    CantDemolishStructuresOnTop = 75,
    CantDemolishVehiclesOnTop = 76,
    StructureIsReserved = 77,
    InvalidSubmission = 78,
    CantEnterEnemyOccupied = 79,
    CantEnterEnemyCV = 80,
    CantEnterEnemyLS = 81,
    CantEnterSealed = 82,
    CantEnterAnchored = 83,
    CantDriveTowedVehicle = 84,
    CantEnterTowedVehicle = 85,
    CantAnchorMovingVehicle = 86,
    CantAnchorSubmergedVehicle = 87,
    CantRaiseAnchorWhenDocked = 88,
    CantRaiseAnchorHatchOpen = 89,
    CantRaiseAnchorDuringRepairs = 90,
    CantAnchorCraneDeployed = 91,
    CantAnchorUnsecuredCargo = 92,
    CantAnchorAtBorder = 93,
    CantAnchorWhenLeaking = 94,
    CantAnchorWhenFlooded = 95,
    CantAnchorNearbyEnemyLargeShip = 96,
    CantInteractEnemyRecoveryMode = 97,
    CantInteractEnemyDriverDisconnected = 98,
    AnchorIsRaising = 99,
    AnchorIsDropping = 100,
    AreaIsObstructed = 101,
    EnemyOwned = 102,
    WaterMineDeploymentFailed = 103,
    WaterMineDeploymentObstructed = 104,
    WaterMineDeploymentTooClose = 105,
    WaterMineDeploymentOutOfRange = 106,
    AssemblyAreaMustBeClosed = 107,
    AssemblyAreaMustBeClear = 108,
    TooFarFromRepairLocation = 109,
    ItemRemoved = 110,
    StockpileOnlyItem = 111,
    ItemTransferredTo = 112,
    CantDropItemOnVehicle = 113,
    ExceedsTowingCapacity = 114,
    CantUseSubmerged = 115,
    AnchorMustBeRaisedShipEngine = 116,
    AnchorMustBeRaisedSubmarineTube = 117,
    CantEjectDriver = 118,
    TooCloseToBorder = 119,
    TorpedoAlreadyLoaded = 120,
    MustClaimOrder = 121,
    AtMaxOrders = 122,
    NotEnoughToCrate = 123,
    OrdersMustBeClear = 124,
    LiquidTankMustBeEmpty = 125,
    RepairWillBeStopped = 126,
    NoReloadNeeded = 127,
    ConcreteSettling = 128,
    NotInSquad = 129,
    InWrongSquad = 130,
    ResetAccessOnCooldown = 131,
    TrainMoving = 132,
    TrainCoupled = 133,
    TrainOffRails = 134,
    MAX = 135,
...
enum class ETechID {
    ...
    UnlockATRPGLight = 11,
    UnlockFlameTorch = 12,
    UnlockGrenadeLauncher = 13,
    UnlockGrenadeLauncherT = 14,
    UnlockISG = 15,
    UnlockMG = 16,
    UnlockMGT = 17,
    UnlockMortar = 18,
    UnlockPistolLight = 19,
    UnlockRevolver = 20,
    UnlockRifle = 21,
    UnlockRifleAutomatic = 22,
    UnlockRifleHeavy = 23,
    UnlockRifleLight = 24,
    UnlockRifleLong = 25,
    UnlockRifleShort = 26,
    ...
    UnlockSMG = 32,
    UnlockSMGHeavy = 33,
    UnlockSniperRifle = 34,
    UnlockBayonet = 35,
    UnlockBinoculars = 36,
    UnlockFirstAidKit = 37,
    UnlockGarrisonSupplies = 38,
    UnlockGasMask = 39,
    UnlockGreenAsh = 40,
    UnlockGrenadeAdapter = 41,
    UnlockHEGrenade = 42,
    UnlockATGrenade = 43,
    UnlockListeningKit = 44,
    UnlockRadioBackpack = 45,
    UnlockSatchelCharge = 46,
    UnlockSatchelChargeT = 47,
    UnlockExplosiveLight = 48,
    UnlockSledgeHammer = 49,
    UnlockSmokeGrenade = 50,
    UnlockSoulstoneTier2 = 51,
    UnlockSoulstoneTier3 = 52,
    UnlockStickyBomb = 53,
    UnlockTankMine = 54,
    UnlockTraumaKit = 55,
    UnlockWindsockT = 56,
    UnlockATGarrison = 57,
    UnlockBunkerBases = 58,
    UnlockConcreteMixer = 59,
    UnlockEmplacedATGun = 60,
    UnlockEmplacedATLarge = 61,
    UnlockEmplacedCannonLarge = 62,
    UnlockEmplacedFieldMG = 63,
    UnlockEmplacedHeavyArtillery = 64,
    UnlockEmplacedIndirect = 65,
    UnlockEmplacedLightArtillery = 66,
    UnlockEmplacedMulti = 67,
    UnlockFacilityMineOilRig = 68,
    UnlockFacilityVehicleFactory3 = 69,
    UnlockFieldBridge = 70,
    UnlockFieldPier = 71,
    UnlockFieldHospital = 72,
    UnlockFort = 73,
    UnlockFortStaticArtillery = 74,
    UnlockGarrisonBuilding = 75,
    UnlockGateTier2 = 76,
    UnlockGateTier3 = 77,
    UnlockLongRangeArtillery = 78,
    UnlockMGGarrison = 79,
    UnlockMineSpline = 80,
    UnlockRifleGarrison = 81,
    UnlockRocket = 82,
    UnlockScrapMine = 83,
    UnlockStaticArtillery = 84,
    UnlockSulfurMine = 85,
    UnlockTankStop = 86,
    UnlockTankStopSplineTier3 = 87,
    UnlockTempMS59 = 88,
    UnlockWallTier2 = 89,
    UnlockWallTier3 = 90,
    UnlockMGPillbox = 91,
    ...
    UnlockAmbulance = 93,
    UnlockArmoredCar = 94,
    UnlockArmoredCarAT = 95,
    UnlockArmoredCarFlame = 96,
    UnlockArmoredCarMobility = 97,
    UnlockArmoredCarOffensive = 98,
    UnlockArmoredCarTwin = 99,
    UnlockBarge = 100,
    UnlockBattleTank = 101,
    UnlockBattleTankDefensive = 102,
    UnlockBattleTankOffensive = 103,
    UnlockBus = 104,
    UnlockConstructionUtility = 105,
    UnlockDestroyerTank = 106,
    UnlockDestroyerTankFlame = 107,
    UnlockFieldArtillery = 108,
    UnlockFieldATGun = 109,
    UnlockFieldATLarge = 110,
    UnlockFieldATDamageGun = 111,
    UnlockFieldAT2 = 112,
    UnlockFieldCannon = 113,
    UnlockFieldCannonDamage = 114,
    UnlockFieldCannonLarge = 115,
    UnlockFieldMG = 116,
    UnlockFieldMortar = 117,
    UnlockFieldMulti = 118,
    UnlockFlatbedTruck = 119,
    UnlockFreighter = 120,
    UnlockGunboat = 121,
    UnlockHalfTrack = 122,
    UnlockHalfTrackDefensive = 123,
    UnlockHalfTrackOffensive = 124,
    UnlockHalfTrackArtillery = 125,
    UnlockHalfTrackMulti = 126,
    UnlockHarvester = 127,
    UnlockLandingCraft = 128,
    UnlockLandingCraftOffensive = 129,
    UnlockLargeShipBattleship = 130,
    UnlockLargeShipBaseShip = 131,
    UnlockLargeShipDestroyer = 132,
    UnlockLargeShipResource = 133,
    UnlockLargeShipStorageShip = 134,
    UnlockLargeShipSubmarine = 135,
    UnlockLightTank = 136,
    UnlockLightTank2Infantry = 137,
    UnlockLightTankArtillery = 138,
    UnlockLightTankFlame = 139,
    UnlockLightTankMobility = 140,
    UnlockLightTankDefensive = 141,
    UnlockLightTankOffensive = 142,
    UnlockMech = 143,
    UnlockMediumTank = 144,
    UnlockMediumTankLarge = 145,
    UnlockMediumTank2 = 146,
    UnlockMediumTank2Indirect = 147,
    UnlockMediumTank2Multi = 148,
    UnlockMediumTank2Range = 149,
    UnlockMediumTank2Twin = 150,
    UnlockMediumTank3 = 151,
    UnlockMediumTankOffensive = 152,
    UnlockMediumTankSiege = 153,
    UnlockMortarTank = 154,
    UnlockMotorcycle = 155,
    UnlockMotorcycleOffensive = 156,
    UnlockRelicArmoredCar = 157,
    UnlockRelicLightTank = 158,
    UnlockRelicMediumTank = 159,
    UnlockRelicScoutVehicle = 160,
    UnlockRelicTruck = 161,
    UnlockScoutTank = 162,
    UnlockScoutTankOffensive = 163,
    UnlockScoutVehicle = 164,
    UnlockScoutVehicleMobility = 165,
    UnlockScoutVehicleOffensive = 166,
    UnlockScoutVehicleUtility = 167,
    UnlockSuperTank = 168,
    UnlockTankette = 169,
    UnlockTanketteFlame = 170,
    UnlockTanketteOffensive = 171,
    UnlockTrainEngine = 172,
    UnlockTruckDefensive = 173,
    UnlockTruckDump = 174,
    UnlockTruckMobility = 175,
    UnlockTruckMulti = 176,
    UnlockTruckOffensive = 177,
    UnlockAdvancedConstruction = 178,
    UnlockFacilityTier2 = 179,
    UnlockFacilityTier3 = 180,
    UnlockAmmoUniform = 181,
    UnlockArmourUniform = 182,
    UnlockChemicalUniform = 183,
    UnlockEngineerUniform = 184,
    UnlockGrenadeUniform = 185,
    UnlockMedicUniform = 186,
    UnlockOfficerUniform = 187,
    UnlockRainUniform = 188,
    UnlockScoutUniform = 189,
    UnlockSnowUniform = 190,
    UnlockTankUniform = 191,
    UnlockHiddenContent = 192,
    Count = 193,
    ETechID_MAX = 194,
};
...
enum class EUnstuckMessage {
    ...
    UnstuckFail = 3,
    UnstuckFailAnchor = 4,
    UnstuckFailDeployed = 5,
    UnstuckFailDisabled = 6,
    UnstuckFailEnemy = 7,
    UnstuckFailHitched = 8,
    UnstuckFailNotOnFoot = 9,
    UnstuckFailMovement = 10,
    UnstuckFailUnsupported = 11,
    UnstuckFailNotInDriverSeat = 12,
    EUnstuckMessage_MAX = 13,
};
