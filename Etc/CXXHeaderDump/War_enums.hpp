...
enum class ETechID {
    ...
    UnlockFieldMulti = 123,
    UnlockFlatbedTruck = 124,
    UnlockFreighter = 125,
    UnlockGunboat = 126,
    UnlockHalfTrack = 127,
    UnlockHalfTrackDefensive = 128,
    UnlockHalfTrackOffensive = 129,
    UnlockHalfTrackArtillery = 130,
    UnlockHalfTrackMulti = 131,
    UnlockHarvester = 132,
    UnlockLandingCraft = 133,
    UnlockLandingCraftOffensive = 134,
    UnlockLargeShipBattleship = 135,
    UnlockLargeShipBaseShip = 136,
    UnlockLargeShipDestroyer = 137,
    UnlockLargeShipResource = 138,
    UnlockLargeShipStorageShip = 139,
    UnlockLargeShipSubmarine = 140,
    UnlockLightTank = 141,
    UnlockLightTank2Infantry = 142,
    UnlockLightTankArtillery = 143,
    UnlockLightTankFlame = 144,
    UnlockLightTankMobility = 145,
    UnlockLightTankDefensive = 146,
    UnlockLightTankOffensive = 147,
    UnlockMech = 148,
    UnlockMediumTank = 149,
    UnlockMediumTankLarge = 150,
    UnlockMediumTank2 = 151,
    UnlockMediumTank2Indirect = 152,
    UnlockMediumTank2Multi = 153,
    UnlockMediumTank2Range = 154,
    UnlockMediumTank2Twin = 155,
    UnlockMediumTank3 = 156,
    UnlockMediumTankOffensive = 157,
    UnlockMediumTankSiege = 158,
    UnlockMortarTank = 159,
    UnlockMotorcycle = 160,
    UnlockMotorcycleOffensive = 161,
    UnlockRelicArmoredCar = 162,
    UnlockRelicLightTank = 163,
    UnlockRelicMediumTank = 164,
    UnlockRelicScoutVehicle = 165,
    UnlockRelicTruck = 166,
    UnlockScoutTank = 167,
    UnlockScoutTankOffensive = 168,
    UnlockScoutVehicle = 169,
    UnlockScoutVehicleMobility = 170,
    UnlockScoutVehicleOffensive = 171,
    UnlockScoutVehicleUtility = 172,
    UnlockSuperTank = 173,
    UnlockTankette = 174,
    UnlockTanketteFlame = 175,
    UnlockTanketteOffensive = 176,
    UnlockTrainEngine = 177,
    UnlockTruckDefensive = 178,
    UnlockTruckDump = 179,
    UnlockTruckMobility = 180,
    UnlockTruckMulti = 181,
    UnlockTruckOffensive = 182,
    UnlockAdvancedConstruction = 183,
    UnlockFacilityTier2 = 184,
    UnlockFacilityTier3 = 185,
    UnlockAmmoUniform = 186,
    UnlockArmourUniform = 187,
    UnlockChemicalUniform = 188,
    UnlockEngineerUniform = 189,
    UnlockGrenadeUniform = 190,
    UnlockMedicUniform = 191,
    UnlockNavalUniform = 192,
    UnlockOfficerUniform = 193,
    UnlockRainUniform = 194,
    UnlockScoutUniform = 195,
    UnlockSnowUniform = 196,
    UnlockTankUniform = 197,
    UnlockHiddenContent = 198,
    Count = 199,
    ETechID_MAX = 200,
};
