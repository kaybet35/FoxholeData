...
class ABPScoutTankMultiW_C : public AScoutTank
{
    ...
    class UPayloadInstancedStaticMeshComponent* PayloadInstancedStaticMesh2;          // 0x1348 (size: 0x8)
    class UPayloadInstancedStaticMeshComponent* PayloadInstancedStaticMesh1;          // 0x1350 (size: 0x8)
    class UPayloadInstancedStaticMeshComponent* PayloadInstancedStaticMesh0;          // 0x1358 (size: 0x8)
    class UCameraComponent* Camera;                                                   // 0x1360 (size: 0x8)
    class UParticleSystemComponent* ExhaustR;                                         // 0x1368 (size: 0x8)
    class UParticleSystemComponent* ExhaustL;                                         // 0x1370 (size: 0x8)
    class UStaticMeshComponent* LightBody;                                            // 0x1378 (size: 0x8)
    class USpotLightComponent* SpotLightBody;                                         // 0x1380 (size: 0x8)
    ...
    class USeatExitComponent* DriverExit;                                             // 0x13A0 (size: 0x8)
