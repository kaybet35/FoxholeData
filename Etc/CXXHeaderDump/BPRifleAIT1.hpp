...
class ABPRifleAIT1_C : public AFortTurret
{
    ...
    class UTemplateComponent* FortCommonT1BreachedWalls;                              // 0x08B8 (size: 0x8)
    class UBoxComponent* BlockBuildSiteMovement;                                      // 0x08C0 (size: 0x8)
    class USeatTriggerComponent* OccupiableTriggerVolume;                             // 0x08C8 (size: 0x8)
