...
class ABPCoalResourceTier2_C : public AResource
{
    ...
    class UStaticMeshComponent* Resource2;                                            // 0x02D0 (size: 0x8)
    class UBoxComponent* Box;                                                         // 0x02D8 (size: 0x8)
    FVector Timeline_0_NewTrack_0_203214FD4C647A29C2ABEC80DA86D914;                   // 0x02E0 (size: 0xC)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_203214FD4C647A29C2ABEC80DA86D914; // 0x02EC (size: 0x1)
