...
#include "ConstructionVehicle.generated.h"
...
class WAR_API AConstructionVehicle : public ARWDSimVehicle, public IGunnerSupport {
    GENERATED_BODY()
public:
protected:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    USceneComponent* BoomLocation;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    USceneComponent* HammerLocation;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    USoundCue* WorkSoundCue;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UParticleSystem* WorkPS;
...
public:
    AConstructionVehicle(const FObjectInitializer& ObjectInitializer);
...
protected:
    ...
    UFUNCTION(BlueprintCallable, Reliable, Server, WithValidation)
    void ServerSetIsWorking(const bool NewBIsWorking);
