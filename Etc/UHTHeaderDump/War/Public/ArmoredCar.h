...
#include "ArmoredCar.generated.h"

UCLASS(Blueprintable)
class WAR_API AArmoredCar : public ARWDSimVehicle, public IGunnerSupport {
    GENERATED_BODY()
public:
private:
...
public:
    AArmoredCar(const FObjectInitializer& ObjectInitializer);
