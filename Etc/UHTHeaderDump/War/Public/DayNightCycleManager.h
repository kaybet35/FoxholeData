...
private:
    ...
    UPROPERTY(EditAnywhere, ReplicatedUsing=OnRep_SunAngleQuantized, meta=(AllowPrivateAccess=true))
...
public:
    ADayNightCycleManager(const FObjectInitializer& ObjectInitializer);
