...
#include "ScoutVehicle.generated.h"

class USceneComponent;

UCLASS(Blueprintable)
class WAR_API AScoutVehicle : public ARWDSimVehicle, public IGunnerSupport {
    GENERATED_BODY()
public:
protected:
...
public:
    AScoutVehicle(const FObjectInitializer& ObjectInitializer);
