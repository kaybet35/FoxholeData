...
#include "RailVehicleCrane.generated.h"
...
class WAR_API ARailVehicleCrane : public ARailVehicle, public IGunnerSupport {
    GENERATED_BODY()
public:
protected:
...
public:
    ARailVehicleCrane(const FObjectInitializer& ObjectInitializer);
