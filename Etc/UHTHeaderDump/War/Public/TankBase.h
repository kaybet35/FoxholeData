...
class WAR_API ATankBase : public ARWDSimVehicle, public IGunnerSupport {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, meta=(AllowPrivateAccess=true))
    UParticleSystemComponent* DisabledFuelTankFX;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSubclassOf<ADecalActor> FuelSpillDecal;
    
    ATankBase(const FObjectInitializer& ObjectInitializer);
