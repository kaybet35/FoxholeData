...
#include "LandingCraft.generated.h"

class UBoxComponent;

UCLASS(Blueprintable)
class WAR_API ALandingCraft : public AAmphibiousVehicle, public IGunnerSupport {
    GENERATED_BODY()
public:
private:
...
public:
    ALandingCraft(const FObjectInitializer& ObjectInitializer);

    virtual void GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const override;

    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool GetBackHatchOpen() const;
