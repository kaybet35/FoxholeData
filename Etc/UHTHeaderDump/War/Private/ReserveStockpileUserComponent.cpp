...
UReserveStockpileUserComponent::UReserveStockpileUserComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void UReserveStockpileUserComponent::ServerResetAccess_Implementation(const FString& StockpileName) {
}
