...
UCraneComponent::UCraneComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->RelevantShippableTarget = NULL;
...
void UCraneComponent::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
    ...
    DOREPLIFETIME(UCraneComponent, RelevantShippableTarget);
}
