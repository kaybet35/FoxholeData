...
public:
    ...
    UFUNCTION(BlueprintCallable, Client, Unreliable)
    void ClientAdjustPosition(float Timestamp, FVector NewLoc, FVector NewVel, UPrimitiveComponent* NewBase, FName NewBaseBoneName, bool bHasBase, bool bBaseRelativePosition, bool bBaseRelativeVelocity, uint8 ServerMovementMode);
