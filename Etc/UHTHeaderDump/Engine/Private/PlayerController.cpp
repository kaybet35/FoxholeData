...
void APlayerController::ClientStopCameraShake_Implementation(TSubclassOf<UCameraShake> Shake, bool bImmediately) {
}
...
void APlayerController::ClientPlayCameraShake_Implementation(TSubclassOf<UCameraShake> Shake, float Scale, TEnumAsByte<ECameraAnimPlaySpace::Type> PlaySpace, FRotator UserPlaySpaceRot) {
}

void APlayerController::ClientPlayCameraAnim_Implementation(UCameraAnim* AnimToPlay, float Scale, float Rate, float BlendInTime, float BlendOutTime, bool bLoop, bool bRandomStartTime, TEnumAsByte<ECameraAnimPlaySpace::Type> Space, FRotator CustomPlaySpace) {
}
