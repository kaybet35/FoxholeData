...
---@param bHasBase boolean
---@param bBaseRelativePosition boolean
---@param bBaseRelativeVelocity boolean
---@param ServerMovementMode uint8
function ACharacter:ClientAdjustRootMotionSourcePosition(Timestamp, ServerRootMotion, bHasAnimRootMotion, ServerMontageTrackPosition, ServerLoc, ServerRotation, ServerVelZ, ServerBase, ServerBoneName, bHasBase, bBaseRelativePosition, bBaseRelativeVelocity, ServerMovementMode) end
---@param Timestamp float
---@param ServerMontageTrackPosition float
---@param ServerLoc FVector
---@param ServerRotation FVector_NetQuantizeNormal
...
---@param bBaseRelativeVelocity boolean
---@param ServerMovementMode uint8
function ACharacter:ClientAdjustRootMotionPosition(Timestamp, ServerMontageTrackPosition, ServerLoc, ServerRotation, ServerVelZ, ServerBase, ServerBoneName, bHasBase, bBaseRelativePosition, bBaseRelativeVelocity, ServerMovementMode) end
---@param Timestamp float
---@param NewLoc FVector
...
---@param bBaseRelativeVelocity boolean
---@param ServerMovementMode uint8
function ACharacter:ClientAdjustPosition(Timestamp, NewLoc, NewVel, NewBase, NewBaseBoneName, bHasBase, bBaseRelativePosition, bBaseRelativeVelocity, ServerMovementMode) end
---@param Timestamp float
...
---@field OutputPoseNodeProperty UStructProperty
...
---@field AnimNodeProperties TArray<UStructProperty>
---@field LinkedAnimGraphNodeProperties TArray<UStructProperty>
---@field LinkedAnimLayerNodeProperties TArray<UStructProperty>
---@field PreUpdateNodeProperties TArray<UStructProperty>
---@field DynamicResetNodeProperties TArray<UStructProperty>
---@field StateMachineNodeProperties TArray<UStructProperty>
---@field InitializationNodeProperties TArray<UStructProperty>
...
---@field bEnableSegmenting boolean
---@field IdealNumFramesPerSegment uint32
---@field MaxNumFramesPerSegment uint32
...
---@field MaxEndEffectorError float
---@field bRunCurrentDefaultCompressor boolean
...
---@field DefaultCompressionAlgorithm TSubclassOf<UAnimCompress>
---@field RotationCompressionFormat AnimationCompressionFormat
---@field TranslationCompressionFormat AnimationCompressionFormat
---@field MaxCurveError float
---@field AlternativeCompressionThreshold float
...
---@field VoipBufferingDelay float
---@field DefaultReverbSendLevel float
---@field bEnableLegacyReverb boolean
...
---@field bShouldApplyFluidZBraking boolean
---@field Mass float
...
---@field HairDefaultMaterial UMaterial
---@field HairDefaultMaterialName FString
---@field HairDebugMaterial UMaterial
---@field HairDebugMaterialName FString
...
---@field MaxES2PixelShaderAdditiveComplexityCount float
...
---@field DefaultCustomTimeStep UEngineCustomTimeStep
---@field CurrentCustomTimeStep UEngineCustomTimeStep
---@field CustomTimeStepClassName FSoftClassPath
---@field DefaultTimecodeProvider UTimecodeProvider
---@field CustomTimecodeProvider UTimecodeProvider
---@field DefaultTimecodeProviderClassName FSoftClassPath
---@field TimecodeProviderClassName FSoftClassPath
---@field DefaultTimecodeFrameRate FFrameRate
...
---@field bOutputVelocityOnBasePass boolean
---@field Expressions TArray<UMaterialExpression>
---@field MaterialFunctionInfos TArray<FMaterialFunctionInfo>
---@field MaterialParameterCollectionInfos TArray<FMaterialParameterCollectionInfo>
...
---@field Description FString
---@field FunctionExpressions TArray<UMaterialExpression>
...
---@field RoleProperty UProperty
---@field RemoteRoleProperty UProperty
---@field NetDriverName FName
...
---@field bUseCollisionChannel boolean
...
---@field bInstancedStereo boolean
---@field bMultiView boolean
---@field bMobileMultiView boolean
---@field bMobileMultiViewDirect boolean
...
---@field AttenuationSettings USoundAttenuation
---@field Modulation FSoundModulation
---@field SoundSubmixObject USoundSubmix
...
---@field ChildSubmixes TArray<USoundSubmix>
---@field ParentSubmix USoundSubmix
---@field ChannelFormat ESubmixChannelFormat
---@field bMuteWhenBackgrounded boolean
---@field SubmixEffectChain TArray<USoundEffectSubmixPreset>
---@field AmbisonicsPluginSettings UAmbisonicsSubmixSettingsBase
---@field EnvelopeFollowerAttackTime int32
---@field EnvelopeFollowerReleaseTime int32
