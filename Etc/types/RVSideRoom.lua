...
---@class ARVSideRoom_C : ABuildableStructure
---@field UberGraphFrame FPointerToUberGraphFrame
---@field TankCollision2 UBoxComponent
---@field TankCollision1 UBoxComponent
---@field TankCollision UBoxComponent
...
---@field SK_RelicLightTank USkeletalMeshComponent
...
function ARVSideRoom_C:Timeline_0__FinishedFunc() end
function ARVSideRoom_C:Timeline_0__UpdateFunc() end
function ARVSideRoom_C:ReceiveBeginPlay() end
---@param EntryPoint int32
function ARVSideRoom_C:ExecuteUbergraph_RVSideRoom(EntryPoint) end
