...
---@class ABPCypressTree03Replacement_C : AClientFoliageReplacement
...
function ABPCypressTree03Replacement_C:ExecuteUbergraph_BPCypressTree03Replacement(EntryPoint) end
