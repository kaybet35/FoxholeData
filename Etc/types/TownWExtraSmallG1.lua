...
---@class ATownWExtraSmallG1_C : AGarrisonHouse
---@field CollisionToBlockMountedPlayerAim2 UBoxComponent
---@field CollisionToBlockMountedPlayerAim1 UBoxComponent
