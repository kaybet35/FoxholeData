...
---@field PropertyType TSubclassOf<UProperty>
FAIDataProviderTypedValue = {}



---@class FAIDataProviderValue
---@field CachedProperty UProperty
...
---@return APawn
function UAIBlueprintHelperLibrary:SpawnAIFromClass(WorldContextObject, PawnClass, BehaviorTree, Location, Rotation, bNoCollisionFail) end
