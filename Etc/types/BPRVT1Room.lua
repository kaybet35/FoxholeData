...
---@class ABPRVT1Room_C : ABuildableStructure
...
function ABPRVT1Room_C:Timeline_0__FinishedFunc() end
function ABPRVT1Room_C:Timeline_0__UpdateFunc() end
function ABPRVT1Room_C:ReceiveBeginPlay() end
---@param EntryPoint int32
function ABPRVT1Room_C:ExecuteUbergraph_BPRVT1Room(EntryPoint) end
